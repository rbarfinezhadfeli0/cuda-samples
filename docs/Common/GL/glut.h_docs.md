# Documentation for Common/GL/glut.h

## File Metadata

- **Path**: `Common/GL/glut.h`
- **Type**: .h
- **Location**: Common/GL
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Common/GL/glut.h`.
