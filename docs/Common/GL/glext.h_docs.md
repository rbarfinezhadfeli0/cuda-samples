# Documentation for Common/GL/glext.h
...
#define GL_COLOR_TABLE_SGI     
... (truncated)
```

## High-Level Overview

This file is part of the CUDA Samples repository, located at `Common/GL/glext.h`.
