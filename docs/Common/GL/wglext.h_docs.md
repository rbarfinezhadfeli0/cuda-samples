# Documentation for Common/GL/wglext.h

## File Metadata

- **Path**: `Common/GL/wglext.h`
- **Type**: .h
- **Location**: Common/GL
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Common/GL/wglext.h`.
