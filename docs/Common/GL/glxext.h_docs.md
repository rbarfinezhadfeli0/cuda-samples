# Documentation for Common/GL/glxext.h

## File Metadata

- **Path**: `Common/GL/glxext.h`
- **Type**: .h
- **Location**: Common/GL
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Common/GL/glxext.h`.
