# Keywords: Common/rendercheck_gl.h
---
...
- **Type**: macro
- **File**: [Common/rendercheck_gl.h](./rendercheck_gl.h_docs.md)
- **Context**: `#define BUFFER_OFFSET(i) ((char *)NULL + (i))

#if _DEBUG
#define CHECK_FBO checkStatus(__FILE__, __`
...
class CheckRender {
 public:
  CheckRender(unsigned int width, unsign`
...
- **File**: [Common/rendercheck_gl.h](./rendercheck_gl.h_docs.md)
- **Context**: `ram =
          nv::CompileASMShader(GL_FRAGMENT_PROGRAM`
...
### _RENDERCHECK_GL_H_ {#rendercheckglh}

- **Type**: macro
- **File**: [Common/rendercheck_gl.h](./rendercheck_gl.h_docs.md)
- **Context**: `#define _RENDERCHECK_GL_H_
...
- **Type**: function
- **File**: [Common/rendercheck_gl.h](./rendercheck_gl.h_docs.md)
- **Context**: `void renderQuad(int width, int height, GLenum eTarget) {`
