# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientMultiDeviceCG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/conjugateGradientMultiDeviceCG/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/conjugateGradientMultiDeviceCG/](./../doc.md)
