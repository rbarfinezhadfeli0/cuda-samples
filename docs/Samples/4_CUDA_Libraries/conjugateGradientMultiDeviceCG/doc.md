# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientMultiDeviceCG/`
...
- [conjugateGradientMultiDeviceCG.cu](./conjugateGradientMultiDeviceCG.cu_docs.md): CUDA kernel implementation
