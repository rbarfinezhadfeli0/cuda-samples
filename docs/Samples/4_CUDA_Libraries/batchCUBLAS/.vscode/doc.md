# Documentation for Folder `Samples/4_CUDA_Libraries/batchCUBLAS/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/batchCUBLAS/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/batchCUBLAS/](./../doc.md)
