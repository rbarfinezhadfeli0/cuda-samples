# Documentation for Folder `Samples/4_CUDA_Libraries/nvJPEG_encoder/encode_output/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/nvJPEG_encoder/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/nvJPEG_encoder/](./../doc.md)
