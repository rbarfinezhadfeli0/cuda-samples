# Documentation for Folder `Samples/4_CUDA_Libraries/histEqualizationNPP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/histEqualizationNPP/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/histEqualizationNPP/](./../doc.md)
