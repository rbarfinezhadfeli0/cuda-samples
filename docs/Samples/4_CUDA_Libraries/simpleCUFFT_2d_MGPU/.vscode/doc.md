# Documentation for Folder `Samples/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/simpleCUFFT_2d_MGPU/](./../doc.md)
