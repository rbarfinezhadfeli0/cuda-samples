# Documentation for Folder `Samples/4_CUDA_Libraries/freeImageInteropNPP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/freeImageInteropNPP/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/freeImageInteropNPP/](./../doc.md)
