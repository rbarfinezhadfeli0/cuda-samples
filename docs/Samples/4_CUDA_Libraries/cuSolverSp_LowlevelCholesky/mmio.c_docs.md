# Documentation: Samples/4_CUDA_Libraries/cuSolverSp_LowlevelCholesky/mmio.c
---
## File Metadata
...
---
## High-Level Overview
This file is a c source file with 12 function(s) in the CUDA Samples repository.
...
### Functions
#### `int mm_read_unsymmetric_sparse(const char *fname, int *M_, int *N_, int *nz_, double **val_, int **I_, int **J_)`
- Function in Samples/4_CUDA_Libraries/cuSolverSp_LowlevelCholesky/mmio.c
