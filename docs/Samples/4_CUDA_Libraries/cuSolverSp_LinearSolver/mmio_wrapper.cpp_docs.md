# Documentation: Samples/4_CUDA_Libraries/cuSolverSp_LinearSolver/mmio_wrapper.cpp
---
## File Metadata
- **Path**: `Samples/4_CUDA_Libraries/cuSolverSp_LinearSolver/mmio_wrapper.cpp`
...
- Function in Samples/4_CUDA_Libraries/cuSolverSp_LinearSolver/mmio_wrapper.cpp
...
### Classes / Structures
#### `struct cooFormat`
- Defined in Samples/4_CUDA_Libraries/cuSolverSp_LinearSolver/mmio_wrapper.cpp
