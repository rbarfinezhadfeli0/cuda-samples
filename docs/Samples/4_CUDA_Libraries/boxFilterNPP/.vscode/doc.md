# Documentation for Folder `Samples/4_CUDA_Libraries/boxFilterNPP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/boxFilterNPP/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/boxFilterNPP/](./../doc.md)
