# Documentation for Samples/4_CUDA_Libraries/simpleCUBLASXT/README.md

## File Metadata

- **Path**: `Samples/4_CUDA_Libraries/simpleCUBLASXT/README.md`
- **Type**: .md
...
This file is part of the CUDA Samples repository, located at `Samples/4_CUDA_Libraries/simpleCUBLASXT/README.md`.
