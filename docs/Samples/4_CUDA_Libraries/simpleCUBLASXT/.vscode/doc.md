# Documentation for Folder `Samples/4_CUDA_Libraries/simpleCUBLASXT/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/simpleCUBLASXT/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/simpleCUBLASXT/](./../doc.md)
