# Documentation for Folder `Samples/4_CUDA_Libraries/nvJPEG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/nvJPEG/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/nvJPEG/](./../doc.md)
