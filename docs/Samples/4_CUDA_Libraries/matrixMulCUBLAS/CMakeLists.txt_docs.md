# Documentation for Samples/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt

## File Metadata

- **Path**: `Samples/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/4_CUDA_Libraries/matrixMulCUBLAS
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/4_CUDA_Libraries/matrixMulCUBLAS/CMakeLists.txt`.
