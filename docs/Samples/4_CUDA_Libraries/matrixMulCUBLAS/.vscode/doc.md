# Documentation for Folder `Samples/4_CUDA_Libraries/matrixMulCUBLAS/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/matrixMulCUBLAS/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/matrixMulCUBLAS/](./../doc.md)
