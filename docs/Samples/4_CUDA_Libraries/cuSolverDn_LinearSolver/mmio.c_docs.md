# Documentation for Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio.c

## File Metadata

- **Path**: `Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio.c`
- **Type**: .c
...
This file is part of the CUDA Samples repository, located at `Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio.c`.
