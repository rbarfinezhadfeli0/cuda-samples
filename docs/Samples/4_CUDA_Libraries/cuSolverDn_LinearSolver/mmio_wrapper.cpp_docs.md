# Documentation: Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio_wrapper.cpp
---
## File Metadata
- **Path**: `Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio_wrapper.cpp`
- **Filename**: `mmio_wrapper.cpp`
- **Language**: cpp
- **Size**: 15941 bytes
- **Lines**: 474
...
### Functions
#### `void compress_index(const int *Ind, int nnz, int m, int *Ptr, int base)`
- Function in Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio_wrapper.cpp
...
#### `int verify_pattern(int m, int nnz, int *csrRowPtr, int *csrColInd)`
- Function in Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio_wrapper.cpp
...
### Classes / Structures
#### `struct cooFormat`
- Defined in Samples/4_CUDA_Libraries/cuSolverDn_LinearSolver/mmio_wrapper.cpp
