# Documentation for Folder `Samples/4_CUDA_Libraries/oceanFFT/`
...
- [oceanFFT.cpp](./oceanFFT.cpp_docs.md): C++ source code
- [oceanFFT_kernel.cu](./oceanFFT_kernel.cu_docs.md): CUDA kernel implementation
