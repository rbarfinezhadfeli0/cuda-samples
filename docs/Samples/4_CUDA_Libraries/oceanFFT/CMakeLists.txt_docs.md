# Documentation for Samples/4_CUDA_Libraries/oceanFFT/CMakeLists.txt

## File Metadata

- **Path**: `Samples/4_CUDA_Libraries/oceanFFT/CMakeLists.txt`
- **Type**: .txt
...
target_compile_features(oceanFFT PRIVATE cxx_std_17 cuda_std_17)
    ...
    message(STATUS "OpenGL not found - will not build sample 'oceanFFT'")
endif()
...
This file is part of the CUDA Samples repository, located at `Samples/4_CUDA_Libraries/oceanFFT/CMakeLists.txt`.
