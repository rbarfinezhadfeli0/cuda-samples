# Documentation for Folder `Samples/4_CUDA_Libraries/simpleCUBLAS_LU/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/simpleCUBLAS_LU/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/simpleCUBLAS_LU/](./../doc.md)
