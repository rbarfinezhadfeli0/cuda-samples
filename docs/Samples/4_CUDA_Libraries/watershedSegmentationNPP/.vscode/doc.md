# Documentation for Folder `Samples/4_CUDA_Libraries/watershedSegmentationNPP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/watershedSegmentationNPP/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/watershedSegmentationNPP/](./../doc.md)
