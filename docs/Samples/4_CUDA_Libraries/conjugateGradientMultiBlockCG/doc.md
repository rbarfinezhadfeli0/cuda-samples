# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientMultiBlockCG/`
...
- [conjugateGradientMultiBlockCG.cu](./conjugateGradientMultiBlockCG.cu_docs.md): CUDA kernel implementation
