# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientMultiBlockCG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/conjugateGradientMultiBlockCG/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/conjugateGradientMultiBlockCG/](./../doc.md)
