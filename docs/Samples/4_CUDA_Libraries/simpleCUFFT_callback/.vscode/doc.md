# Documentation for Folder `Samples/4_CUDA_Libraries/simpleCUFFT_callback/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/simpleCUFFT_callback/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/simpleCUFFT_callback/](./../doc.md)
