# Documentation for Samples/4_CUDA_Libraries/simpleCUFFT_callback/CMakeLists.txt
...
This file is part of the CUDA Samples repository, located at `Samples/4_CUDA_Libraries/simpleCUFFT_callback/CMakeLists.txt`.
