# Documentation for Folder `Samples/4_CUDA_Libraries/simpleCUFFT_callback/`
...
- [simpleCUFFT_callback.cu](./simpleCUFFT_callback.cu_docs.md): CUDA kernel implementation
