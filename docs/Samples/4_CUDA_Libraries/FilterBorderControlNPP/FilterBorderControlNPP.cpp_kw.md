# Keywords: Samples/4_CUDA_Libraries/FilterBorderControlNPP/FilterBorderControlNPP.cpp
---
...
- **Type**: identifier
- **File**: [Samples/4_CUDA_Libraries/FilterBorderControlNPP/FilterBorderControlNPP.cpp](./FilterBorderControlNPP.cpp_docs.md)
- **Context**: ` image
...
- **File**: [Samples/4_CUDA_Libraries/FilterBorderControlNPP/FilterBorderControlNPP.cpp](./FilterBorderControlNPP.cpp_docs.md)
- **Context**: `y size
        npp::ImageNPP_16s_C1 oDeviceDstX(oSizeRO`
