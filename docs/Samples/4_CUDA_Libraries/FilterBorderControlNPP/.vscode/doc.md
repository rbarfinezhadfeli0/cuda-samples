# Documentation for Folder `Samples/4_CUDA_Libraries/FilterBorderControlNPP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/FilterBorderControlNPP/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/FilterBorderControlNPP/](./../doc.md)
