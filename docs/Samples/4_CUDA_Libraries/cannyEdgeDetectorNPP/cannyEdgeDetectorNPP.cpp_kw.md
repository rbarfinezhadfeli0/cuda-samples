# Keywords: Samples/4_CUDA_Libraries/cannyEdgeDetectorNPP/cannyEdgeDetectorNPP.cpp
---
...
- **Type**: identifier
- **File**: [Samples/4_CUDA_Libraries/cannyEdgeDetectorNPP/cannyEdgeDetectorNPP.cpp](./cannyEdgeDetectorNPP.cpp_docs.md)
- **Context**: ` image
