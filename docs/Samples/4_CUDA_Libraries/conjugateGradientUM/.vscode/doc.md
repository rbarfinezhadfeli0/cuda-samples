# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientUM/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/conjugateGradientUM/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/conjugateGradientUM/](./../doc.md)
