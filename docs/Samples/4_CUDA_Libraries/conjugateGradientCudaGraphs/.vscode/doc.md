# Documentation for Folder `Samples/4_CUDA_Libraries/conjugateGradientCudaGraphs/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/conjugateGradientCudaGraphs/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/conjugateGradientCudaGraphs/](./../doc.md)
