# Documentation for Folder `Samples/4_CUDA_Libraries/lineOfSight/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/4_CUDA_Libraries/lineOfSight/`.
...
- **Parent**: [Samples/4_CUDA_Libraries/lineOfSight/](./../doc.md)
