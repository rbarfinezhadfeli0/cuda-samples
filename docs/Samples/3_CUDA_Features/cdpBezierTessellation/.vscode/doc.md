# Documentation for Folder `Samples/3_CUDA_Features/cdpBezierTessellation/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cdpBezierTessellation/`.
...
- **Parent**: [Samples/3_CUDA_Features/cdpBezierTessellation/](./../doc.md)
