# Documentation for Folder `Samples/3_CUDA_Features/cudaCompressibleMemory/`
...
- [compMalloc.cpp](./compMalloc.cpp_docs.md): C++ source code
- [saxpy.cu](./saxpy.cu_docs.md): CUDA kernel implementation
