# Documentation for Folder `Samples/3_CUDA_Features/cudaCompressibleMemory/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cudaCompressibleMemory/`.
...
- **Parent**: [Samples/3_CUDA_Features/cudaCompressibleMemory/](./../doc.md)
