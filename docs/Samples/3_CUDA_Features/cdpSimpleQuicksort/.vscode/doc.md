# Documentation for Folder `Samples/3_CUDA_Features/cdpSimpleQuicksort/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cdpSimpleQuicksort/`.
...
- **Parent**: [Samples/3_CUDA_Features/cdpSimpleQuicksort/](./../doc.md)
