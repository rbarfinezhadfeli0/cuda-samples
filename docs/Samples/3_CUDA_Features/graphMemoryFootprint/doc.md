# Documentation for Folder `Samples/3_CUDA_Features/graphMemoryFootprint/`
...
- [graphMemoryFootprint.cu](./graphMemoryFootprint.cu_docs.md): CUDA kernel implementation
