# Documentation for Folder `Samples/3_CUDA_Features/graphMemoryFootprint/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/graphMemoryFootprint/`.
...
- **Parent**: [Samples/3_CUDA_Features/graphMemoryFootprint/](./../doc.md)
