# Documentation for Folder `Samples/3_CUDA_Features/memMapIPCDrv/`
...
- [memMapIpc.cpp](./memMapIpc.cpp_docs.md): C++ source code
- [memMapIpc_kernel.cu](./memMapIpc_kernel.cu_docs.md): CUDA kernel implementation
