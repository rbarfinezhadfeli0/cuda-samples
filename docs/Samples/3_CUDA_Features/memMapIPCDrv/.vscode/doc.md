# Documentation for Folder `Samples/3_CUDA_Features/memMapIPCDrv/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/memMapIPCDrv/`.
...
- **Parent**: [Samples/3_CUDA_Features/memMapIPCDrv/](./../doc.md)
