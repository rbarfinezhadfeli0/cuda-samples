# Subtree Keyword Index for `Samples/3_CUDA_Features/`
...
**ALLOWABLE_VARIANCE**
- [Samples/3_CUDA_Features/graphMemoryNodes/graphMemoryNodes.cu](graphMemoryNodes/graphMemoryNodes.cu_docs.md)

**Ampere**
- [Samples/3_CUDA_Features/dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu](dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu_docs.md)

**alignas**
- [Samples/3_CUDA_Features/globalToShmemAsyncCopy/globalToShmemAsyncCopy.cu](globalToShmemAsyncCopy/globalToShmemAsyncCopy.cu_docs.md)

**allocateCompressible**
- [Samples/3_CUDA_Features/cudaCompressibleMemory/compMalloc.cpp](cudaCompressibleMemory/compMalloc.cpp_docs.md)
- [Samples/3_CUDA_Features/cudaCompressibleMemory/compMalloc.h](cudaCompressibleMemory/compMalloc.h_docs.md)

**are**
- [Samples/3_CUDA_Features/dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu](dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu_docs.md)

**atomicAdd**
- [Samples/3_CUDA_Features/jacobiCudaGraphs/jacobi.cu](jacobiCudaGraphs/jacobi.cu_docs.md)
...
**BITONICSORT_LEN**
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpQuicksort.h](cdpAdvancedQuicksort/cdpQuicksort.h_docs.md)

**BLOCK_COL_TILES**
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](bf16TensorCoreGemm/bf16TensorCoreGemm.cu_docs.md)
- [Samples/3_CUDA_Features/cudaTensorCoreGemm/cudaTensorCoreGemm.cu](cudaTensorCoreGemm/cudaTensorCoreGemm.cu_docs.md)
- [Samples/3_CUDA_Features/dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu](dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu_docs.md)
- [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](immaTensorCoreGemm/immaTensorCoreGemm.cu_docs.md)
- [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](tf32TensorCoreGemm/tf32TensorCoreGemm.cu_docs.md)
...
**Bounding_box**
- [Samples/3_CUDA_Features/cdpQuadtree/cdpQuadtree.cu](cdpQuadtree/cdpQuadtree.cu_docs.md)

**barrierWait**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc.cpp](memMapIPCDrv/memMapIpc.cpp_docs.md)

**bf16TensorCoreGemm**
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/CMakeLists.txt](bf16TensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](bf16TensorCoreGemm/bf16TensorCoreGemm.cu_docs.md)

**big_bitonicsort**
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpBitonicSort.cu](cdpAdvancedQuicksort/cdpBitonicSort.cu_docs.md)
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpQuicksort.h](cdpAdvancedQuicksort/cdpQuicksort.h_docs.md)

**big_bitonicsort_kernel**
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpBitonicSort.cu](cdpAdvancedQuicksort/cdpBitonicSort.cu_docs.md)

**binaryPartitionCG**
- [Samples/3_CUDA_Features/binaryPartitionCG/CMakeLists.txt](binaryPartitionCG/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/binaryPartitionCG/binaryPartitionCG.cu](binaryPartitionCG/binaryPartitionCG.cu_docs.md)

**bindlessTexture**
- [Samples/3_CUDA_Features/bindlessTexture/CMakeLists.txt](bindlessTexture/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/bindlessTexture.cpp](bindlessTexture/bindlessTexture.cpp_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/bindlessTexture.h](bindlessTexture/bindlessTexture.h_docs.md)

**bindlessTexture_kernel**
- [Samples/3_CUDA_Features/bindlessTexture/bindlessTexture_kernel.cu](bindlessTexture/bindlessTexture_kernel.cu_docs.md)
...
**block**
- [Samples/3_CUDA_Features/StreamPriorities/StreamPriorities.cu](StreamPriorities/StreamPriorities.cu_docs.md)
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](bf16TensorCoreGemm/bf16TensorCoreGemm.cu_docs.md)
- [Samples/3_CUDA_Features/binaryPartitionCG/binaryPartitionCG.cu](binaryPartitionCG/binaryPartitionCG.cu_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/bindlessTexture.cpp](bindlessTexture/bindlessTexture.cpp_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/bindlessTexture_kernel.cu](bindlessTexture/bindlessTexture_kernel.cu_docs.md)
...
**CMakeLists**
- [Samples/3_CUDA_Features/CMakeLists.txt](CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/StreamPriorities/CMakeLists.txt](StreamPriorities/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/CMakeLists.txt](bf16TensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/binaryPartitionCG/CMakeLists.txt](binaryPartitionCG/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/CMakeLists.txt](bindlessTexture/CMakeLists.txt_docs.md)
- *(and 20 more files)*
...
- [Samples/3_CUDA_Features/ptxjit/ptxjit.cpp](ptxjit/ptxjit.cpp_docs.md)
...
**ComplexType_t**
- [Samples/3_CUDA_Features/newdelete/newdelete.cu](newdelete/newdelete.cu_docs.md)
...
**calculateMaxInEachBuckets**
- [Samples/3_CUDA_Features/warpAggregatedAtomicsCG/warpAggregatedAtomicsCG.cu](warpAggregatedAtomicsCG/warpAggregatedAtomicsCG.cu_docs.md)

**callBackData**
- [Samples/3_CUDA_Features/simpleCudaGraphs/simpleCudaGraphs.cu](simpleCudaGraphs/simpleCudaGraphs.cu_docs.md)

**capabilities**
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpAdvancedQuicksort.cu](cdpAdvancedQuicksort/cdpAdvancedQuicksort.cu_docs.md)
- [Samples/3_CUDA_Features/cdpQuadtree/cdpQuadtree.cu](cdpQuadtree/cdpQuadtree.cu_docs.md)

**capturedWhileEmptyKernel**
- [Samples/3_CUDA_Features/graphConditionalNodes/graphConditionalNodes.cu](graphConditionalNodes/graphConditionalNodes.cu_docs.md)
...
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/CMakeLists.txt](cdpAdvancedQuicksort/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpAdvancedQuicksort.cu](cdpAdvancedQuicksort/cdpAdvancedQuicksort.cu_docs.md)

**cdpBezierTessellation**
- [Samples/3_CUDA_Features/cdpBezierTessellation/CMakeLists.txt](cdpBezierTessellation/CMakeLists.txt_docs.md)

**cdpBitonicSort**
- [Samples/3_CUDA_Features/cdpAdvancedQuicksort/cdpBitonicSort.cu](cdpAdvancedQuicksort/cdpBitonicSort.cu_docs.md)

**cdpQuadtree**
- [Samples/3_CUDA_Features/cdpQuadtree/CMakeLists.txt](cdpQuadtree/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/cdpQuadtree/cdpQuadtree.cu](cdpQuadtree/cdpQuadtree.cu_docs.md)
...
**cdpSimplePrint**
- [Samples/3_CUDA_Features/cdpSimplePrint/CMakeLists.txt](cdpSimplePrint/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/cdpSimplePrint/cdpSimplePrint.cu](cdpSimplePrint/cdpSimplePrint.cu_docs.md)

**cdpSimpleQuicksort**
- [Samples/3_CUDA_Features/cdpSimpleQuicksort/CMakeLists.txt](cdpSimpleQuicksort/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/cdpSimpleQuicksort/cdpSimpleQuicksort.cu](cdpSimpleQuicksort/cdpSimpleQuicksort.cu_docs.md)
...
**cleanupMemory**
- [Samples/3_CUDA_Features/graphMemoryFootprint/graphMemoryFootprint.cu](graphMemoryFootprint/graphMemoryFootprint.cu_docs.md)
...
**createLinearSystem**
- [Samples/3_CUDA_Features/jacobiCudaGraphs/main.cpp](jacobiCudaGraphs/main.cpp_docs.md)

**createNegateSquaresGraphExplicitly**
- [Samples/3_CUDA_Features/graphMemoryNodes/graphMemoryNodes.cu](graphMemoryNodes/graphMemoryNodes.cu_docs.md)

**createNegateSquaresGraphWithStreamCapture**
- [Samples/3_CUDA_Features/graphMemoryNodes/graphMemoryNodes.cu](graphMemoryNodes/graphMemoryNodes.cu_docs.md)

**createSimpleAllocFreeGraph**
- [Samples/3_CUDA_Features/graphMemoryFootprint/graphMemoryFootprint.cu](graphMemoryFootprint/graphMemoryFootprint.cu_docs.md)

**createSimpleAllocNoFreeGraph**
- [Samples/3_CUDA_Features/graphMemoryFootprint/graphMemoryFootprint.cu](graphMemoryFootprint/graphMemoryFootprint.cu_docs.md)
...
- [Samples/3_CUDA_Features/cudaCompressibleMemory/CMakeLists.txt](cudaCompressibleMemory/CMakeLists.txt_docs.md)
...
**cudaTensorCoreGemm**
- [Samples/3_CUDA_Features/cudaTensorCoreGemm/CMakeLists.txt](cudaTensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/cudaTensorCoreGemm/cudaTensorCoreGemm.cu](cudaTensorCoreGemm/cudaTensorCoreGemm.cu_docs.md)
...
**dmmaTensorCoreGemm**
- [Samples/3_CUDA_Features/dmmaTensorCoreGemm/CMakeLists.txt](dmmaTensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu](dmmaTensorCoreGemm/dmmaTensorCoreGemm.cu_docs.md)
...
- [Samples/3_CUDA_Features/globalToShmemAsyncCopy/CMakeLists.txt](globalToShmemAsyncCopy/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/globalToShmemAsyncCopy/globalToShmemAsyncCopy.cu](globalToShmemAsyncCopy/globalToShmemAsyncCopy.cu_docs.md)
...
- [Samples/3_CUDA_Features/graphConditionalNodes/CMakeLists.txt](graphConditionalNodes/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/graphConditionalNodes/graphConditionalNodes.cu](graphConditionalNodes/graphConditionalNodes.cu_docs.md)

**graphMemoryFootprint**
- [Samples/3_CUDA_Features/graphMemoryFootprint/CMakeLists.txt](graphMemoryFootprint/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/graphMemoryFootprint/graphMemoryFootprint.cu](graphMemoryFootprint/graphMemoryFootprint.cu_docs.md)

**graphMemoryNodes**
- [Samples/3_CUDA_Features/graphMemoryNodes/CMakeLists.txt](graphMemoryNodes/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/graphMemoryNodes/graphMemoryNodes.cu](graphMemoryNodes/graphMemoryNodes.cu_docs.md)
...
**immaTensorCoreGemm**
- [Samples/3_CUDA_Features/immaTensorCoreGemm/CMakeLists.txt](immaTensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](immaTensorCoreGemm/immaTensorCoreGemm.cu_docs.md)
...
**JACOBI_H**
- [Samples/3_CUDA_Features/jacobiCudaGraphs/jacobi.h](jacobiCudaGraphs/jacobi.h_docs.md)
...
**jacobiCudaGraphs**
- [Samples/3_CUDA_Features/jacobiCudaGraphs/CMakeLists.txt](jacobiCudaGraphs/CMakeLists.txt_docs.md)
...
**memMapAllocateAndExportMemory**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc.cpp](memMapIPCDrv/memMapIpc.cpp_docs.md)

**memMapGetDeviceFunction**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc.cpp](memMapIPCDrv/memMapIpc.cpp_docs.md)

**memMapIPCDrv**
- [Samples/3_CUDA_Features/memMapIPCDrv/CMakeLists.txt](memMapIPCDrv/CMakeLists.txt_docs.md)

**memMapImportAndMapMemory**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc.cpp](memMapIPCDrv/memMapIpc.cpp_docs.md)
...
**memMapIpc_kernel**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc_kernel.cu](memMapIPCDrv/memMapIpc_kernel.cu_docs.md)

**memMapUnmapAndFreeMemory**
- [Samples/3_CUDA_Features/memMapIPCDrv/memMapIpc.cpp](memMapIPCDrv/memMapIpc.cpp_docs.md)
...
**myKernel**
- [Samples/3_CUDA_Features/ptxjit/ptxjit_kernel.cu](ptxjit/ptxjit_kernel.cu_docs.md)
...
**newdelete**
- [Samples/3_CUDA_Features/newdelete/CMakeLists.txt](newdelete/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/newdelete/newdelete.cu](newdelete/newdelete.cu_docs.md)
...
**ptxjit**
- [Samples/3_CUDA_Features/ptxjit/CMakeLists.txt](ptxjit/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/ptxjit/ptxjit.cpp](ptxjit/ptxjit.cpp_docs.md)
...
**README**
- [Samples/3_CUDA_Features/README.md](README.md_docs.md)
- [Samples/3_CUDA_Features/StreamPriorities/README.md](StreamPriorities/README.md_docs.md)
- [Samples/3_CUDA_Features/bf16TensorCoreGemm/README.md](bf16TensorCoreGemm/README.md_docs.md)
- [Samples/3_CUDA_Features/binaryPartitionCG/README.md](binaryPartitionCG/README.md_docs.md)
- [Samples/3_CUDA_Features/bindlessTexture/README.md](bindlessTexture/README.md_docs.md)
- *(and 20 more files)*
...
**simpleCudaGraphs**
- [Samples/3_CUDA_Features/simpleCudaGraphs/CMakeLists.txt](simpleCudaGraphs/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/simpleCudaGraphs/simpleCudaGraphs.cu](simpleCudaGraphs/simpleCudaGraphs.cu_docs.md)
...
**tf32TensorCoreGemm**
- [Samples/3_CUDA_Features/tf32TensorCoreGemm/CMakeLists.txt](tf32TensorCoreGemm/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](tf32TensorCoreGemm/tf32TensorCoreGemm.cu_docs.md)
...
- [Samples/3_CUDA_Features/warpAggregatedAtomicsCG/CMakeLists.txt](warpAggregatedAtomicsCG/CMakeLists.txt_docs.md)
- [Samples/3_CUDA_Features/warpAggregatedAtomicsCG/warpAggregatedAtomicsCG.cu](warpAggregatedAtomicsCG/warpAggregatedAtomicsCG.cu_docs.md)
...
`BLOCK_COL_TILES`, `BLOCK_COL_WARPS`, `BLOCK_ROW_TILES`, `BLOCK_ROW_WARPS`, `CHUNK_COPY_LINES_PER_WARP`, `CHUNK_COPY_LINE_LANES`, `CHUNK_K`, `CHUNK_LINE_BYTES`, `CMakeLists`, `CPU_DEBUG`, `C_LAYOUT`, `DAMAGES`, `GEMM`, `GLOBAL_MEM_STRIDE`, `K`, `K_GLOBAL`, `K_TILES`, `M`, `M_GLOBAL`, `M_TILES`, `N`, `N_GLOBAL`, `N_TILES`, `README`, `SHARED_MEMORY_LIMIT_64K`, `SHMEM_OFFSET`, `SHMEM_STRIDE`, `SKEW_BF16`, `THREADS_PER_BLOCK`, `Volta`
...
`BLOCK_COL_TILES`, `BLOCK_COL_WARPS`, `BLOCK_ROW_TILES`, `BLOCK_ROW_WARPS`, `CHUNK_COPY_LINES_PER_WARP`, `CHUNK_COPY_LINE_LANES`, `CHUNK_K`, `CHUNK_LINE_BYTES`, `CMakeLists`, `CPU_DEBUG`, `C_LAYOUT`, `DAMAGES`, `GEMM`, `GLOBAL_MEM_STRIDE`, `K`, `K_GLOBAL`, `K_TILES`, `M`, `M_GLOBAL`, `M_TILES`, `N`, `N_GLOBAL`, `N_TILES`, `README`, `SHARED_MEMORY_LIMIT_64K`, `SHMEM_OFFSET`, `SHMEM_STRIDE`, `SKEW_HALF`, `THREADS_PER_BLOCK`, `Volta`

#### dmmaTensorCoreGemm/

`Ampere`, `BLOCK_COL_TILES`, `BLOCK_COL_WARPS`, `BLOCK_ROW_TILES`, `BLOCK_ROW_WARPS`, `CHUNK_COPY_LINES_PER_WARP`, `CHUNK_COPY_LINE_LANES`, `CHUNK_K`, `CHUNK_LINE_BYTES`, `CMakeLists`, `CPU_DEBUG`, `C_LAYOUT`, `DAMAGES`, `DGEMM`, `GLOBAL_MEM_STRIDE`, `K`, `K_GLOBAL`, `K_TILES`, `M`, `M_GLOBAL`, `M_TILES`, `N`, `N_GLOBAL`, `N_TILES`, `README`, `SHARED_MEMORY_LIMIT_64K`, `SHMEM_OFFSET`, `SHMEM_STRIDE`, `SKEW_DOUBLE`, `THREADS_PER_BLOCK`
...
`BLOCK_COL_TILES`, `BLOCK_COL_WARPS`, `BLOCK_ROW_TILES`, `BLOCK_ROW_WARPS`, `CHUNK_COPY_LINES_PER_WARP`, `CHUNK_COPY_LINE_LANES`, `CHUNK_K`, `CHUNK_LINE_BYTES`, `CMakeLists`, `CPU_DEBUG`, `C_LAYOUT`, `DAMAGES`, `GEMM`, `GLOBAL_MEM_STRIDE`, `K`, `K_GLOBAL`, `K_TILES`, `M`, `M_GLOBAL`, `M_TILES`, `N`, `N_GLOBAL`, `N_TILES`, `README`, `SHARED_MEMORY_LIMIT_64K`, `SHMEM_OFFSET`, `SHMEM_STRIDE`, `SKEW_UINT8`, `THREADS_PER_BLOCK`, `Volta`
