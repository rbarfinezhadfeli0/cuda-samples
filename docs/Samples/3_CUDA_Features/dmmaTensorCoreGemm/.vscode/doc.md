# Documentation for Folder `Samples/3_CUDA_Features/dmmaTensorCoreGemm/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/dmmaTensorCoreGemm/`.
...
- **Parent**: [Samples/3_CUDA_Features/dmmaTensorCoreGemm/](./../doc.md)
