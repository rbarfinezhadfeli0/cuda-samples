# Documentation for Folder `Samples/3_CUDA_Features/cudaTensorCoreGemm/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cudaTensorCoreGemm/`.
...
- **Parent**: [Samples/3_CUDA_Features/cudaTensorCoreGemm/](./../doc.md)
