# Documentation for Folder `Samples/3_CUDA_Features/bindlessTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/bindlessTexture/`.
...
- **Parent**: [Samples/3_CUDA_Features/bindlessTexture/](./../doc.md)
