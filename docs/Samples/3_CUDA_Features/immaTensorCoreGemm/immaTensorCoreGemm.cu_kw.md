# Keywords: Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu
---
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `#define CHUNK_LINE_BYTES          (CHUNK_K * K * sizeof(uint8_t))
...
### SKEW_UINT8 {#skewuint8}

- **Type**: macro
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `#define SKEW_UINT8 32
...
### compute_gemm_imma {#computegemmimma}

- **Type**: cuda_kernel
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `__global__ void compute_gemm_imma(`
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `void init_host_matrices(uint8_t *a, uint8_t *b, int *c)
{`
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `void matMultiplyOnHost(uint8_t *A,
                                uint8_t *B,
                     `
...
### simple_wmma_gemm_imma {#simplewmmagemmimma}

- **Type**: cuda_kernel
- **File**: [Samples/3_CUDA_Features/immaTensorCoreGemm/immaTensorCoreGemm.cu](./immaTensorCoreGemm.cu_docs.md)
- **Context**: `__global__ void simple_wmma_gemm_imma(`
