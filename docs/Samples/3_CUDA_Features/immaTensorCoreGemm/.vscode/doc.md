# Documentation for Folder `Samples/3_CUDA_Features/immaTensorCoreGemm/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/immaTensorCoreGemm/`.
...
- **Parent**: [Samples/3_CUDA_Features/immaTensorCoreGemm/](./../doc.md)
