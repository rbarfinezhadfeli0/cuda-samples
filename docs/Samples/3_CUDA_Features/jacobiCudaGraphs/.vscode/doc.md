# Documentation for Folder `Samples/3_CUDA_Features/jacobiCudaGraphs/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/jacobiCudaGraphs/`.
...
- **Parent**: [Samples/3_CUDA_Features/jacobiCudaGraphs/](./../doc.md)
