# Documentation for Folder `Samples/3_CUDA_Features/cdpQuadtree/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cdpQuadtree/`.
...
- **Parent**: [Samples/3_CUDA_Features/cdpQuadtree/](./../doc.md)
