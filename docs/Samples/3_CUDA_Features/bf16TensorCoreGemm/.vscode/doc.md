# Documentation for Folder `Samples/3_CUDA_Features/bf16TensorCoreGemm/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/bf16TensorCoreGemm/`.
...
- **Parent**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/](./../doc.md)
