# Keywords: Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu
---
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
- **Context**: `#define CHUNK_LINE_BYTES          (CHUNK_K * K * sizeof(__nv_bfloat16))
...
// Performs an MxNxK bf16 GEMM (C=alpha*`
...
### compute_bf16gemm {#computebf16gemm}
...
### compute_bf16gemm_async_copy {#computebf16gemmasynccopy}

- **Type**: cuda_kernel
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
- **Context**: `__global__ void compute_bf16gemm_async_copy(`
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
- **Context**: `void init_host_matrices(__nv_bfloat16 *a, __nv_bfloat16 *b, float *c)
{`
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
- **Context**: `void matMultiplyOnHost(__nv_bfloat16 *A,
                                __nv_bfloat16 *B,
         `
...
### simple_wmma_bf16gemm {#simplewmmabf16gemm}

- **Type**: cuda_kernel
- **File**: [Samples/3_CUDA_Features/bf16TensorCoreGemm/bf16TensorCoreGemm.cu](./bf16TensorCoreGemm.cu_docs.md)
- **Context**: `__global__ void simple_wmma_bf16gemm(`
