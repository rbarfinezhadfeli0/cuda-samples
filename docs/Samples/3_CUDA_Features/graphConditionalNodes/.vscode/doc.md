# Documentation for Folder `Samples/3_CUDA_Features/graphConditionalNodes/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/graphConditionalNodes/`.
...
- **Parent**: [Samples/3_CUDA_Features/graphConditionalNodes/](./../doc.md)
