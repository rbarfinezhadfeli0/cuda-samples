# Documentation for Folder `Samples/3_CUDA_Features/cdpAdvancedQuicksort/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cdpAdvancedQuicksort/`.
...
- **Parent**: [Samples/3_CUDA_Features/cdpAdvancedQuicksort/](./../doc.md)
