# Documentation for Folder `Samples/3_CUDA_Features/cdpAdvancedQuicksort/`
...
- [cdpAdvancedQuicksort.cu](./cdpAdvancedQuicksort.cu_docs.md): CUDA kernel implementation
- [cdpBitonicSort.cu](./cdpBitonicSort.cu_docs.md): CUDA kernel implementation
