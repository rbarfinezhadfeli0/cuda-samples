# Documentation for Folder `Samples/3_CUDA_Features/simpleCudaGraphs/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/simpleCudaGraphs/`.
...
- **Parent**: [Samples/3_CUDA_Features/simpleCudaGraphs/](./../doc.md)
