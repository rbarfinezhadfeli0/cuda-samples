# Documentation for Folder `Samples/3_CUDA_Features/globalToShmemAsyncCopy/`
...
- [globalToShmemAsyncCopy.cu](./globalToShmemAsyncCopy.cu_docs.md): CUDA kernel implementation
