# Documentation for Folder `Samples/3_CUDA_Features/globalToShmemAsyncCopy/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/globalToShmemAsyncCopy/`.
...
- **Parent**: [Samples/3_CUDA_Features/globalToShmemAsyncCopy/](./../doc.md)
