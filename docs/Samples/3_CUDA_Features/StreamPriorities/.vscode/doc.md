# Documentation for Folder `Samples/3_CUDA_Features/StreamPriorities/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/StreamPriorities/`.
...
- **Parent**: [Samples/3_CUDA_Features/StreamPriorities/](./../doc.md)
