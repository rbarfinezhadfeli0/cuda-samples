# Documentation for Folder `Samples/3_CUDA_Features/tf32TensorCoreGemm/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/tf32TensorCoreGemm/`.
...
- **Parent**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/](./../doc.md)
