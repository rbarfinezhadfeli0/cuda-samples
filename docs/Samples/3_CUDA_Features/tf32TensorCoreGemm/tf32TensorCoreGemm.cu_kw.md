# Keywords: Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu
---
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
...
- **Type**: macro
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
- **Context**: `#define CHUNK_LINE_BYTES          (CHUNK_K * K * sizeof(float))
#define WARP_COPY_BYTES           (W`
...
// Performs an MxNxK tf32 GEMM (C=alpha*`
...
### SKEW_FLOAT {#skewfloat}

- **Type**: macro
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
- **Context**: `#define SKEW_FLOAT 8
...
### compute_tf32gemm {#computetf32gemm}

- **Type**: cuda_kernel
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
- **Context**: `__global__ void compute_tf32gemm(`

### compute_tf32gemm_async_copy {#computetf32gemmasynccopy}
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
- **Context**: `void init_host_matrices(float *a, float *b, float *c)
{`
...
- **Type**: function
- **File**: [Samples/3_CUDA_Features/tf32TensorCoreGemm/tf32TensorCoreGemm.cu](./tf32TensorCoreGemm.cu_docs.md)
- **Context**: `void matMultiplyOnHost(float *A,
                                float *B,
                         `
...
### simple_wmma_tf32gemm {#simplewmmatf32gemm}
