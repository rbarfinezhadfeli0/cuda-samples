# Documentation for Folder `Samples/3_CUDA_Features/binaryPartitionCG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/binaryPartitionCG/`.
...
- **Parent**: [Samples/3_CUDA_Features/binaryPartitionCG/](./../doc.md)
