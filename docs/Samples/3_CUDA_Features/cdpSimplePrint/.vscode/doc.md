# Documentation for Folder `Samples/3_CUDA_Features/cdpSimplePrint/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/cdpSimplePrint/`.
...
- **Parent**: [Samples/3_CUDA_Features/cdpSimplePrint/](./../doc.md)
