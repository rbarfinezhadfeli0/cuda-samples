# Documentation for Folder `Samples/3_CUDA_Features/warpAggregatedAtomicsCG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/warpAggregatedAtomicsCG/`.
...
- **Parent**: [Samples/3_CUDA_Features/warpAggregatedAtomicsCG/](./../doc.md)
