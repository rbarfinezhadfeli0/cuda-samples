# Documentation for Folder `Samples/3_CUDA_Features/warpAggregatedAtomicsCG/`
...
- [warpAggregatedAtomicsCG.cu](./warpAggregatedAtomicsCG.cu_docs.md): CUDA kernel implementation
