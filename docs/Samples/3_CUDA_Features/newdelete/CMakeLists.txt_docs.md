# Documentation for Samples/3_CUDA_Features/newdelete/CMakeLists.txt

## File Metadata

- **Path**: `Samples/3_CUDA_Features/newdelete/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/3_CUDA_Features/newdelete/CMakeLists.txt`.
