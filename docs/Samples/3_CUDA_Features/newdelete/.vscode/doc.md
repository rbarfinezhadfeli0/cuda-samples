# Documentation for Folder `Samples/3_CUDA_Features/newdelete/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/3_CUDA_Features/newdelete/`.
...
- **Parent**: [Samples/3_CUDA_Features/newdelete/](./../doc.md)
