# Documentation for Folder `Samples/8_Platform_Specific/Tegra/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/`.
...
- **Parent**: [Samples/8_Platform_Specific/](./../doc.md)
