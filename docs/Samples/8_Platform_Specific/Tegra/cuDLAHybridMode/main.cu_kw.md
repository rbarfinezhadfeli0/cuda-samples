# Keywords: Samples/8_Platform_Specific/Tegra/cuDLAHybridMode/main.cu
---
...
- **Type**: macro
- **File**: [Samples/8_Platform_Specific/Tegra/cuDLAHybridMode/main.cu](./main.cu_docs.md)
