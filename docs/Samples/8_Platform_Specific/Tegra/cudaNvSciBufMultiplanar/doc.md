# Documentation for Folder `Samples/8_Platform_Specific/Tegra/cudaNvSciBufMultiplanar/`
...
- [cudaNvSciBufMultiplanar.cpp](./cudaNvSciBufMultiplanar.cpp_docs.md): C++ source code
- [imageKernels.cu](./imageKernels.cu_docs.md): CUDA kernel implementation
