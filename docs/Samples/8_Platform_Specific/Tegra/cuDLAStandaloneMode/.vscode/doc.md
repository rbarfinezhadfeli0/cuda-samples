# Documentation for Folder `Samples/8_Platform_Specific/Tegra/cuDLAStandaloneMode/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/cuDLAStandaloneMode/`.
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/cuDLAStandaloneMode/](./../doc.md)
