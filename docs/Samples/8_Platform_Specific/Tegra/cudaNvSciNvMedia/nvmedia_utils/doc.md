# Documentation for Folder `Samples/8_Platform_Specific/Tegra/cudaNvSciNvMedia/nvmedia_utils/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/cudaNvSciNvMedia/`.
...
- [cmdline.cpp](./cmdline.cpp_docs.md): C++ source code
- [config_parser.cpp](./config_parser.cpp_docs.md): C++ source code
- [image_utils.cpp](./image_utils.cpp_docs.md): C++ source code
- [log_utils.cpp](./log_utils.cpp_docs.md): C++ source code
- [misc_utils.cpp](./misc_utils.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/cudaNvSciNvMedia/](./../doc.md)
