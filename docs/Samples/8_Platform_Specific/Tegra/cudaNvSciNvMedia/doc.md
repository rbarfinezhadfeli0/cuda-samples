# Documentation for Folder `Samples/8_Platform_Specific/Tegra/cudaNvSciNvMedia/`
...
- [cuda_consumer.cu](./cuda_consumer.cu_docs.md): CUDA kernel implementation
- [main.cpp](./main.cpp_docs.md): C++ source code
- [nvmedia_producer.cpp](./nvmedia_producer.cpp_docs.md): C++ source code
- [nvsci_setup.cpp](./nvsci_setup.cpp_docs.md): C++ source code
