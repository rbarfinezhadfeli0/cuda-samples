# Documentation for Folder `Samples/8_Platform_Specific/Tegra/EGLSync_CUDAEvent_Interop/`
...
- [EGLSync_CUDAEvent_Interop.cu](./EGLSync_CUDAEvent_Interop.cu_docs.md): CUDA kernel implementation
