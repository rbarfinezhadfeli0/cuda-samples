# Documentation for Folder `Samples/8_Platform_Specific/Tegra/EGLSync_CUDAEvent_Interop/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/EGLSync_CUDAEvent_Interop/`.
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/EGLSync_CUDAEvent_Interop/](./../doc.md)
