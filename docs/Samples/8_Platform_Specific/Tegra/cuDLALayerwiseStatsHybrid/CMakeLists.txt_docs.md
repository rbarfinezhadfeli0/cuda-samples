# Documentation for Samples/8_Platform_Specific/Tegra/cuDLALayerwiseStatsHybrid/CMakeLists.txt

## File Metadata

- **Path**: `Samples/8_Platform_Specific/Tegra/cuDLALayerwiseStatsHybrid/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/8_Platform_Specific/Tegra/cuDLALayerwiseStatsHybrid
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/8_Platform_Specific/Tegra/cuDLALayerwiseStatsHybrid/CMakeLists.txt`.
