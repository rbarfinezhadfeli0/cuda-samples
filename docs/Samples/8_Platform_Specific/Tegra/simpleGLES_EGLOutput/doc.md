# Documentation for Folder `Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/`
...
- [simpleGLES_EGLOutput.cu](./simpleGLES_EGLOutput.cu_docs.md): CUDA kernel implementation
