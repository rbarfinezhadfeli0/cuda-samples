# Keywords: Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/simpleGLES_EGLOutput.cu
---
...
- **Type**: macro
- **File**: [Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/simpleGLES_EGLOutput.cu](./simpleGLES_EGLOutput.cu_docs.md)
...
- **Type**: function
- **File**: [Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/simpleGLES_EGLOutput.cu](./simpleGLES_EGLOutput.cu_docs.md)
- **Context**: `void InitGraphicsState(char **argv)
{`
