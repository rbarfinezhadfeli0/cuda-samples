# Documentation for Folder `Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/`.
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/simpleGLES_EGLOutput/](./../doc.md)
