# Documentation for Folder `Samples/8_Platform_Specific/Tegra/nbody_opengles/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/nbody_opengles/`.
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/nbody_opengles/](./../doc.md)
