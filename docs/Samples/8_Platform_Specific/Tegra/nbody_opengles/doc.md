# Documentation for Folder `Samples/8_Platform_Specific/Tegra/nbody_opengles/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/`.
...
- [bodysystemcuda.cu](./bodysystemcuda.cu_docs.md): CUDA kernel implementation
- [nbody_opengles.cpp](./nbody_opengles.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/](./../doc.md)
