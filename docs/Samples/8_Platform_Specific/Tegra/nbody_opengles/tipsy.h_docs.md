# Documentation: Samples/8_Platform_Specific/Tegra/nbody_opengles/tipsy.h
---
## File Metadata
...
---
## High-Level Overview
This file is a h source file with 1 function(s) and 4 class/struct definition(s) in the CUDA Samples repository.
...
#### `void read_tipsy_file(vector<real4>     &bodyPositions,
                     ...
                     int               &NSecond,
                     int               &NThird)`
- Function in Samples/8_Platform_Specific/Tegra/nbody_opengles/tipsy.h

### Classes / Structures
#### `struct gas_particle`
- Defined in Samples/8_Platform_Specific/Tegra/nbody_opengles/tipsy.h
