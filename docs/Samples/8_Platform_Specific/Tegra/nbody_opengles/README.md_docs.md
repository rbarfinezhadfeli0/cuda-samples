# Documentation for Samples/8_Platform_Specific/Tegra/nbody_opengles/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/8_Platform_Specific/Tegra/nbody_opengles/README.md`.
