# Keywords: Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES_kernels.cu
---
...
- **Type**: identifier
- **File**: [Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES_kernels.cu](./fluidsGLES_kernels.cu_docs.md)
- **Context**: ` <GLES3/gl31.h>

// FluidsGLES CUDA kernel definit`
