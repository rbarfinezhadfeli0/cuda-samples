# Documentation for Folder `Samples/8_Platform_Specific/Tegra/fluidsGLES/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/8_Platform_Specific/Tegra/fluidsGLES/`.
...
- **Parent**: [Samples/8_Platform_Specific/Tegra/fluidsGLES/](./../doc.md)
