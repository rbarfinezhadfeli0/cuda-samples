# Documentation: Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES.cpp
---
## File Metadata
- **Path**: `Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES.cpp`
- **Filename**: `fluidsGLES.cpp`
- **Language**: cpp
- **Size**: 20576 bytes
- **Lines**: 696
...
- **MAX_EPSILON_ERROR**: `1.0f`

### Functions
#### `void error_exit(const char *format, ...)`
- Function in Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES.cpp
...
#### `void InitGraphicsState(int argc, char **argv)`
- Function in Samples/8_Platform_Specific/Tegra/fluidsGLES/fluidsGLES.cpp
