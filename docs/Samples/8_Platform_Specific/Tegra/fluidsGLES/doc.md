# Documentation for Folder `Samples/8_Platform_Specific/Tegra/fluidsGLES/`
...
- [fluidsGLES.cpp](./fluidsGLES.cpp_docs.md): C++ source code
- [fluidsGLES_kernels.cu](./fluidsGLES_kernels.cu_docs.md): CUDA kernel implementation
