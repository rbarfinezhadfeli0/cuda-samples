# Documentation for Folder `Samples/7_libNVVM/cuda-c-linking/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/7_libNVVM/`.
...
- [cuda-c-linking.cpp](./cuda-c-linking.cpp_docs.md): C++ source code
- [math-funcs.cu](./math-funcs.cu_docs.md): CUDA kernel implementation
...
- **Parent**: [Samples/7_libNVVM/](./../doc.md)
