# Documentation for Folder `Samples/7_libNVVM/common/include/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/7_libNVVM/common/`.
...
- **Parent**: [Samples/7_libNVVM/common/](./../doc.md)
