# Documentation for Samples/7_libNVVM/simple/README.md

## File Metadata

- **Path**: `Samples/7_libNVVM/simple/README.md`
- **Type**: .md
...
This file is part of the CUDA Samples repository, located at `Samples/7_libNVVM/simple/README.md`.
