# Documentation for Samples/1_Utilities/deviceQueryDrv/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/1_Utilities/deviceQueryDrv/README.md`.
