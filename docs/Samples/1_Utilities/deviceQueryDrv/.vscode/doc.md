# Documentation for Folder `Samples/1_Utilities/deviceQueryDrv/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/1_Utilities/deviceQueryDrv/`.
...
- **Parent**: [Samples/1_Utilities/deviceQueryDrv/](./../doc.md)
