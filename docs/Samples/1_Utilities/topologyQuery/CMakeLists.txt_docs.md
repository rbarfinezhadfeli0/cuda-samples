# Documentation for Samples/1_Utilities/topologyQuery/CMakeLists.txt
...
This file is part of the CUDA Samples repository, located at `Samples/1_Utilities/topologyQuery/CMakeLists.txt`.
