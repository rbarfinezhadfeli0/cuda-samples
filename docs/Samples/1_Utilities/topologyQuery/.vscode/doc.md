# Documentation for Folder `Samples/1_Utilities/topologyQuery/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/1_Utilities/topologyQuery/`.
...
- **Parent**: [Samples/1_Utilities/topologyQuery/](./../doc.md)
