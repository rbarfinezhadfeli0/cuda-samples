# Documentation for Folder `Samples/1_Utilities/topologyQuery/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/1_Utilities/`.
...
- [topologyQuery.cu](./topologyQuery.cu_docs.md): CUDA kernel implementation
...
- **Parent**: [Samples/1_Utilities/](./../doc.md)
