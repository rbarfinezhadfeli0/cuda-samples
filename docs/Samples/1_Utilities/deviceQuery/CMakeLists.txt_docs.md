# Documentation for Samples/1_Utilities/deviceQuery/CMakeLists.txt

## File Metadata

- **Path**: `Samples/1_Utilities/deviceQuery/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/1_Utilities/deviceQuery/CMakeLists.txt`.
