# Documentation for Folder `Samples/1_Utilities/deviceQuery/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/1_Utilities/deviceQuery/`.
...
- **Parent**: [Samples/1_Utilities/deviceQuery/](./../doc.md)
