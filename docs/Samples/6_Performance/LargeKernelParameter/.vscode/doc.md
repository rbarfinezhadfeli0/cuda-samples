# Documentation for Folder `Samples/6_Performance/LargeKernelParameter/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/LargeKernelParameter/`.
...
- **Parent**: [Samples/6_Performance/LargeKernelParameter/](./../doc.md)
