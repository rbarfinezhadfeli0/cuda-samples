# Documentation for Samples/6_Performance/LargeKernelParameter/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/6_Performance/LargeKernelParameter/README.md`.
