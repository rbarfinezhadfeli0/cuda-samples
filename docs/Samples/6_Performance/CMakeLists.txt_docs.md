# Documentation for Samples/6_Performance/CMakeLists.txt

## File Metadata

- **Path**: `Samples/6_Performance/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/6_Performance/CMakeLists.txt`.
