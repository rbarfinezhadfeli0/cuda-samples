# Documentation for Folder `Samples/6_Performance/alignedTypes/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/alignedTypes/`.
...
- **Parent**: [Samples/6_Performance/alignedTypes/](./../doc.md)
