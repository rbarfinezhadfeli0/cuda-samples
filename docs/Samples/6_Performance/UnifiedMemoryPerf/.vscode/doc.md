# Documentation for Folder `Samples/6_Performance/UnifiedMemoryPerf/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/UnifiedMemoryPerf/`.
...
- **Parent**: [Samples/6_Performance/UnifiedMemoryPerf/](./../doc.md)
