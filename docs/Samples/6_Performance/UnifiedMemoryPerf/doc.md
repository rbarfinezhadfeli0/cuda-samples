# Documentation for Folder `Samples/6_Performance/UnifiedMemoryPerf/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/`.
...
- [commonKernels.cu](./commonKernels.cu_docs.md): CUDA kernel implementation
- [helperFunctions.cpp](./helperFunctions.cpp_docs.md): C++ source code
- [matrixMultiplyPerf.cu](./matrixMultiplyPerf.cu_docs.md): CUDA kernel implementation
...
- **Parent**: [Samples/6_Performance/](./../doc.md)
