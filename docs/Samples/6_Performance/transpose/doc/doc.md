# Documentation for Folder `Samples/6_Performance/transpose/doc/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/transpose/`.
...
- **Parent**: [Samples/6_Performance/transpose/](./../doc.md)
