# Documentation for Samples/6_Performance/transpose/CMakeLists.txt

## File Metadata

- **Path**: `Samples/6_Performance/transpose/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/6_Performance/transpose
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/6_Performance/transpose/CMakeLists.txt`.
