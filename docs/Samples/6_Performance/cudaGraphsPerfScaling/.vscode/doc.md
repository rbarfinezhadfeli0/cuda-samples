# Documentation for Folder `Samples/6_Performance/cudaGraphsPerfScaling/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/6_Performance/cudaGraphsPerfScaling/`.
...
- **Parent**: [Samples/6_Performance/cudaGraphsPerfScaling/](./../doc.md)
