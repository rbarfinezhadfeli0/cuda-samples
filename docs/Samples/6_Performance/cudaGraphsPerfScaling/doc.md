# Documentation for Folder `Samples/6_Performance/cudaGraphsPerfScaling/`
...
- [cudaGraphPerfScaling.cu](./cudaGraphPerfScaling.cu_docs.md): CUDA kernel implementation
