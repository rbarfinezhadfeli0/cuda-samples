# Documentation: Samples/5_Domain_Specific/nbody/tipsy.h
---
## File Metadata
- **Path**: `Samples/5_Domain_Specific/nbody/tipsy.h`
- **Filename**: `tipsy.h`
- **Language**: h
- **Size**: 3749 bytes
- **Lines**: 167
...
#### `void read_tipsy_file(vector<real4>     &bodyPositions,
                     ...
                     int               &NSecond,
                     int               &NThird)`
- Function in Samples/5_Domain_Specific/nbody/tipsy.h

### Classes / Structures
#### `struct gas_particle`
- Defined in Samples/5_Domain_Specific/nbody/tipsy.h
