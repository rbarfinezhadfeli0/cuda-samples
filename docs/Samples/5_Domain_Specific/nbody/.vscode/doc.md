# Documentation for Folder `Samples/5_Domain_Specific/nbody/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/nbody/`.
...
- **Parent**: [Samples/5_Domain_Specific/nbody/](./../doc.md)
