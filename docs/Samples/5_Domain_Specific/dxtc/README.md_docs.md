# Documentation for Samples/5_Domain_Specific/dxtc/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/dxtc/README.md`.
