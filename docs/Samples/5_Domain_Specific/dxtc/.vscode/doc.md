# Documentation for Folder `Samples/5_Domain_Specific/dxtc/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/dxtc/`.
...
- **Parent**: [Samples/5_Domain_Specific/dxtc/](./../doc.md)
