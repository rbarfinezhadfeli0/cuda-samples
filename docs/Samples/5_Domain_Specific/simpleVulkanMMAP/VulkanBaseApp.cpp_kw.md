# Keywords: Samples/5_Domain_Specific/simpleVulkanMMAP/VulkanBaseApp.cpp
---
...
- **Type**: identifier
- **File**: [Samples/5_Domain_Specific/simpleVulkanMMAP/VulkanBaseApp.cpp](./VulkanBaseApp.cpp_docs.md)
...
- **Context**: `ityAttributes;
    ...
    VkExportSemaphoreWin32HandleInfoKHR exportSemaphoreWin3`
...
- **Context**: `presentModes);
    ...
    VkPhysicalDeviceIDPropertiesKHR vkPhysicalDeviceIDP`
...
- **Context**: `.pNext = NULL;
    ...
    VkPhysicalDeviceProperties2KHR vkPhysicalDevicePro`
