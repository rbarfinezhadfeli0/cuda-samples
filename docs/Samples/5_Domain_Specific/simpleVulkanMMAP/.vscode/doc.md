# Documentation for Folder `Samples/5_Domain_Specific/simpleVulkanMMAP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/simpleVulkanMMAP/`.
...
- **Parent**: [Samples/5_Domain_Specific/simpleVulkanMMAP/](./../doc.md)
