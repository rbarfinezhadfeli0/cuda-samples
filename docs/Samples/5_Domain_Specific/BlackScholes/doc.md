# Documentation for Folder `Samples/5_Domain_Specific/BlackScholes/`
...
- [BlackScholes.cu](./BlackScholes.cu_docs.md): CUDA kernel implementation
- [BlackScholes_gold.cpp](./BlackScholes_gold.cpp_docs.md): C++ source code
