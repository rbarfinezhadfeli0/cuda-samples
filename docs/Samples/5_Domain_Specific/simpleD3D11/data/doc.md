# Documentation for Folder `Samples/5_Domain_Specific/simpleD3D11/data/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/simpleD3D11/`.
...
- **Parent**: [Samples/5_Domain_Specific/simpleD3D11/](./../doc.md)
