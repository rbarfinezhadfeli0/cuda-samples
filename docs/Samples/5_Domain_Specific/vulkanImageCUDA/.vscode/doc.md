# Documentation for Folder `Samples/5_Domain_Specific/vulkanImageCUDA/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/vulkanImageCUDA/`.
...
- **Parent**: [Samples/5_Domain_Specific/vulkanImageCUDA/](./../doc.md)
