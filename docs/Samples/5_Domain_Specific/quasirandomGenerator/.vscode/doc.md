# Documentation for Folder `Samples/5_Domain_Specific/quasirandomGenerator/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/quasirandomGenerator/`.
...
- **Parent**: [Samples/5_Domain_Specific/quasirandomGenerator/](./../doc.md)
