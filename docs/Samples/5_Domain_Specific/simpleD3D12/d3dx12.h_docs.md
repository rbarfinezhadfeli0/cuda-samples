# Documentation: Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
---
## File Metadata
- **Path**: `Samples/5_Domain_Specific/simpleD3D12/d3dx12.h`
- **Filename**: `d3dx12.h`
- **Language**: h
- **Size**: 70031 bytes
- **Lines**: 1470
...
---
## High-Level Overview
This file is a h source file with 49 function(s) and 1 class/struct definition(s) in the CUDA Samples repository.
...
- **__D3DX12_H__**: `#include "d3d12.h"`

### Functions
#### `explicit CD3DX12_RECT(LONG Left, LONG Top, LONG Right, LONG Bottom)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `CD3DX12_RESOURCE_BARRIER Transition(_In_ ID3D12Resource         *pResource,
               D3D12_RESOURCE_STATES        stateBefore,
               D3D12_RESOURCE_STATES        stateAfter,
               UINT                         subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES,
               D3D12_RESOURCE_BARRIER_FLAGS flags       = D3D12_RESOURCE_BARRIER_FLAG_NONE)`
...
#### `CD3DX12_RESOURCE_BARRIER Aliasing(_In_ ID3D12Resource *pResourceBefore,
                                                    _In_ ID3D12Resource *pResourceAfter)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `CD3DX12_RESOURCE_BARRIER UAV(_In_ ID3D12Resource *pResource)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `void Init(_Out_ D3D12_DESCRIPTOR_RANGE &range,
                            D3D12_DESCRIPTOR_RANGE_TYPE   rangeType,
                            UINT                          numDescriptors,
                            UINT                          baseShaderRegister,
                            UINT                          registerSpace = 0,
...
#### `void Init(_Out_ D3D12_ROOT_CONSTANTS &rootConstants, UINT num32BitValues, UINT shaderRegister, UINT registerSpace = 0)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `void Init(UINT shaderRegister, UINT registerSpace = 0)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `void Init(_Out_ D3D12_ROOT_DESCRIPTOR &table, UINT shaderRegister, UINT registerSpace = 0)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `void InitAsConstants(_Out_ D3D12_ROOT_PARAMETER &rootParam,
                                       UINT                        num32BitValues,
                                       UINT                        shaderRegister,
                                       UINT                        registerSpace = 0,
                                       D3D12_SHADER_VISIBILITY     visibility    = D3D12_SHADER_VISIBILITY_ALL)`
...
#### `void InitAsConstantBufferView(_Out_ D3D12_ROOT_PARAMETER &rootParam,
                                                UINT                        shaderRegister,
                                                UINT                        registerSpace = 0,
                                                D3D12_SHADER_VISIBILITY     visibility    = D3D12_SHADER_VISIBILITY_ALL)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `void InitAsShaderResourceView(_Out_ D3D12_ROOT_PARAMETER &rootParam,
                                                UINT                        shaderRegister,
                                                UINT                        registerSpace = 0,
                                                D3D12_SHADER_VISIBILITY     visibility    = D3D12_SHADER_VISIBILITY_ALL)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h

#### `void InitAsUnorderedAccessView(_Out_ D3D12_ROOT_PARAMETER &rootParam,
                                                 UINT                        shaderRegister,
                                                 UINT                        registerSpace = 0,
                                                 D3D12_SHADER_VISIBILITY     visibility = D3D12_SHADER_VISIBILITY_ALL)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `void Init(_Out_ D3D12_STATIC_SAMPLER_DESC &samplerDesc,
                            UINT                             shaderRegister,
                            D3D12_FILTER                     filter           = D3D12_FILTER_ANISOTROPIC,
                            D3D12_TEXTURE_ADDRESS_MODE       addressU         = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
                            D3D12_TEXTURE_ADDRESS_MODE       addressV         = D3D12_TEXTURE_ADDRESS_MODE_WRAP,
...
#### `void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE      &handle,
                                     _In_ const D3D12_CPU_DESCRIPTOR_HANDLE &base,
                                     INT                                     offsetScaledByIncrementSize)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE      &handle,
                                     _In_ const D3D12_GPU_DESCRIPTOR_HANDLE &base,
                                     INT                                     offsetScaledByIncrementSize)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `CD3DX12_RESOURCE_DESC Buffer(const D3D12_RESOURCE_ALLOCATION_INFO &resAllocInfo,
                                               D3D12_RESOURCE_FLAGS                  flags = D3D12_RESOURCE_FLAG_NONE)`
- Function in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
#### `CD3DX12_RESOURCE_DESC Tex1D(DXGI_FORMAT          format,
                                              UINT64               width,
                                              UINT16               arraySize = 1,
                                              UINT16               mipLevels = 0,
                                              D3D12_RESOURCE_FLAGS flags     = D3D12_RESOURCE_FLAG_NONE,
...
#### `CD3DX12_RESOURCE_DESC Tex2D(DXGI_FORMAT          format,
                                              UINT64               width,
                                              UINT                 height,
                                              UINT16               arraySize     = 1,
                                              UINT16               mipLevels     = 0,
...
#### `CD3DX12_RESOURCE_DESC Tex3D(DXGI_FORMAT          format,
                                              UINT64               width,
                                              UINT                 height,
                                              UINT16               depth,
                                              UINT16               mipLevels = 0,
...
### Classes / Structures
#### `struct CD3DX12_DEFAULT`
- Defined in Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
