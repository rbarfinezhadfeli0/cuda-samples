# Documentation for Samples/5_Domain_Specific/simpleD3D12/d3dx12.h
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
    ...
    static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTO
... (truncated)
```

## High-Level Overview

This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/simpleD3D12/d3dx12.h`.
