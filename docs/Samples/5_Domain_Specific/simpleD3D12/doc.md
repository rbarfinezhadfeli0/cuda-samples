# Documentation for Folder `Samples/5_Domain_Specific/simpleD3D12/`
...
- [DX12CudaSample.cpp](./DX12CudaSample.cpp_docs.md): C++ source code
- [Main.cpp](./Main.cpp_docs.md): C++ source code
- [README.md](./README.md_docs.md): Sample documentation
- [Win32Application.cpp](./Win32Application.cpp_docs.md): C++ source code
- [simpleD3D12.cpp](./simpleD3D12.cpp_docs.md): C++ source code
- [sinewave_cuda.cu](./sinewave_cuda.cu_docs.md): CUDA kernel implementation
- [stdafx.cpp](./stdafx.cpp_docs.md): C++ source code
