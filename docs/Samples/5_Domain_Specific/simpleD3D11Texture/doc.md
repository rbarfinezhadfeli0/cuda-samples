# Documentation for Folder `Samples/5_Domain_Specific/simpleD3D11Texture/`
...
- [simpleD3D11Texture.cpp](./simpleD3D11Texture.cpp_docs.md): C++ source code
- [texture_2d.cu](./texture_2d.cu_docs.md): CUDA kernel implementation
- [texture_3d.cu](./texture_3d.cu_docs.md): CUDA kernel implementation
- [texture_cube.cu](./texture_cube.cu_docs.md): CUDA kernel implementation
