# Documentation for Folder `Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/simpleD3D11Texture/`.
...
- **Parent**: [Samples/5_Domain_Specific/simpleD3D11Texture/](./../doc.md)
