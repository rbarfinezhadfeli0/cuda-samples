# Documentation: Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h
---
## File Metadata
- **Path**: `Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h`
- **Filename**: `d3dx11effect.h`
- **Language**: h
- **Size**: 81709 bytes
- **Lines**: 1729
...
---
## High-Level Overview
This file is a h source file with 21 function(s) and 9 class/struct definition(s) in the CUDA Samples repository.
...
- **__D3DX11EFFECT_H__**: `#include "d3d11.h"`
- **D3DX11_BYTES_FROM_BITS**: ``
- **D3DX11_EFFECT_OPTIMIZED**: `(1 << 21)`
- **D3DX11_EFFECT_CLONE**: `(1 << 22)`
- **D3DX11_EFFECT_RUNTIME_VALID_FLAGS**: `(0)`
- **D3DX11_EFFECT_VARIABLE_ANNOTATION**: `(1 << 1)`
- **D3DX11_EFFECT_VARIABLE_EXPLICIT_BIND_POINT**: `(1 << 2)`
- **D3DX11_EFFECT_CLONE_FORCE_NONSINGLE**: `(1 << 0)`
- **D3DX11_EFFECT_PASS_COMMIT_CHANGES**: `(1 << 0) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_SHADERS_AND_INTERFACES**: `(1 << 1) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_STATE_OBJECTS**: `(1 << 2) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_RTVS_AND_DSVS**: `(1 << 3) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_SAMPLERS**: `(1 << 4) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_CBS**: `(1 << 5) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_SRVS**: `(1 << 6) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_OMIT_UAVS**: `(1 << 7) // TODO: not yet implemented`
- **D3DX11_EFFECT_PASS_ONLY_SET_SHADERS_AND_CBS**: `\`
- **INTERFACE**: `ID3DX11EffectType`
- **INTERFACE**: `ID3DX11EffectVariable`
- **INTERFACE**: `ID3DX11EffectScalarVariable`
- **INTERFACE**: `ID3DX11EffectVectorVariable`
- **INTERFACE**: `ID3DX11EffectMatrixVariable`
- **INTERFACE**: `ID3DX11EffectStringVariable`
- **INTERFACE**: `ID3DX11EffectClassInstanceVariable`
- **INTERFACE**: `ID3DX11EffectInterfaceVariable`
- **INTERFACE**: `ID3DX11EffectShaderResourceVariable`
- **INTERFACE**: `ID3DX11EffectUnorderedAccessViewVariable`
- **INTERFACE**: `ID3DX11EffectRenderTargetViewVariable`
- **INTERFACE**: `ID3DX11EffectDepthStencilViewVariable`
- **INTERFACE**: `ID3DX11EffectConstantBuffer`
- **INTERFACE**: `ID3DX11EffectShaderVariable`
- **INTERFACE**: `ID3DX11EffectBlendVariable`
- **INTERFACE**: `ID3DX11EffectDepthStencilVariable`
- **INTERFACE**: `ID3DX11EffectRasterizerVariable`
- **INTERFACE**: `ID3DX11EffectSamplerVariable`
- **INTERFACE**: `ID3DX11EffectPass`
- **INTERFACE**: `ID3DX11EffectTechnique`
- **INTERFACE**: `ID3DX11EffectGroup`
- **INTERFACE**: `ID3DX11Effect`

### Functions
#### `ID3DX11EffectType DECLARE_INTERFACE(ID3DX11EffectType)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectScalarVariable DECLARE_INTERFACE_(ID3DX11EffectScalarVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectVectorVariable DECLARE_INTERFACE_(ID3DX11EffectVectorVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectMatrixVariable DECLARE_INTERFACE_(ID3DX11EffectMatrixVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectStringVariable DECLARE_INTERFACE_(ID3DX11EffectStringVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectClassInstanceVariable DECLARE_INTERFACE_(ID3DX11EffectClassInstanceVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectInterfaceVariable DECLARE_INTERFACE_(ID3DX11EffectInterfaceVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectShaderResourceVariable DECLARE_INTERFACE_(ID3DX11EffectShaderResourceVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectUnorderedAccessViewVariable DECLARE_INTERFACE_(ID3DX11EffectUnorderedAccessViewVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectRenderTargetViewVariable DECLARE_INTERFACE_(ID3DX11EffectRenderTargetViewVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectDepthStencilViewVariable DECLARE_INTERFACE_(ID3DX11EffectDepthStencilViewVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectConstantBuffer DECLARE_INTERFACE_(ID3DX11EffectConstantBuffer, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectShaderVariable DECLARE_INTERFACE_(ID3DX11EffectShaderVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectBlendVariable DECLARE_INTERFACE_(ID3DX11EffectBlendVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectDepthStencilVariable DECLARE_INTERFACE_(ID3DX11EffectDepthStencilVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectRasterizerVariable DECLARE_INTERFACE_(ID3DX11EffectRasterizerVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectSamplerVariable DECLARE_INTERFACE_(ID3DX11EffectSamplerVariable, ID3DX11EffectVariable)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectPass DECLARE_INTERFACE(ID3DX11EffectPass)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectTechnique DECLARE_INTERFACE(ID3DX11EffectTechnique)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11EffectGroup DECLARE_INTERFACE(ID3DX11EffectGroup)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

#### `ID3DX11Effect DECLARE_INTERFACE_(ID3DX11Effect, IUnknown)`
- Function in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h

### Classes / Structures
#### `struct _D3DX11_STATE_BLOCK_MASK`
- Defined in Samples/5_Domain_Specific/simpleD3D11Texture/d3dx11effect/d3dx11effect.h
