# Documentation for Samples/5_Domain_Specific/simpleD3D11Texture/CMakeLists.txt
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/simpleD3D11Texture/CMakeLists.txt`.
