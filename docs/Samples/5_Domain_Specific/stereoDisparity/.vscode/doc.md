# Documentation for Folder `Samples/5_Domain_Specific/stereoDisparity/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/stereoDisparity/`.
...
- **Parent**: [Samples/5_Domain_Specific/stereoDisparity/](./../doc.md)
