# Documentation for Folder `Samples/5_Domain_Specific/fastWalshTransform/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/fastWalshTransform/`.
...
- **Parent**: [Samples/5_Domain_Specific/fastWalshTransform/](./../doc.md)
