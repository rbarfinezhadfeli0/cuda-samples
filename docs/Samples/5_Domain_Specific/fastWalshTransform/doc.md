# Documentation for Folder `Samples/5_Domain_Specific/fastWalshTransform/`
...
- [fastWalshTransform.cu](./fastWalshTransform.cu_docs.md): CUDA kernel implementation
- [fastWalshTransform_gold.cpp](./fastWalshTransform_gold.cpp_docs.md): C++ source code
