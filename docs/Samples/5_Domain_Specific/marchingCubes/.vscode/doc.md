# Documentation for Folder `Samples/5_Domain_Specific/marchingCubes/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/marchingCubes/`.
...
- **Parent**: [Samples/5_Domain_Specific/marchingCubes/](./../doc.md)
