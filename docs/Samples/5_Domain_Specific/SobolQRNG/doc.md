# Documentation for Folder `Samples/5_Domain_Specific/SobolQRNG/`
...
- [sobol.cpp](./sobol.cpp_docs.md): C++ source code
- [sobol_gold.cpp](./sobol_gold.cpp_docs.md): C++ source code
- [sobol_gpu.cu](./sobol_gpu.cu_docs.md): CUDA kernel implementation
- [sobol_primitives.cpp](./sobol_primitives.cpp_docs.md): C++ source code
