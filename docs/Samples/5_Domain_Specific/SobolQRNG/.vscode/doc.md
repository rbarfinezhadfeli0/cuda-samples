# Documentation for Folder `Samples/5_Domain_Specific/SobolQRNG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/SobolQRNG/`.
...
- **Parent**: [Samples/5_Domain_Specific/SobolQRNG/](./../doc.md)
