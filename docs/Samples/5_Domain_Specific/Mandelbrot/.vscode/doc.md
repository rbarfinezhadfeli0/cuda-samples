# Documentation for Folder `Samples/5_Domain_Specific/Mandelbrot/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/Mandelbrot/`.
...
- **Parent**: [Samples/5_Domain_Specific/Mandelbrot/](./../doc.md)
