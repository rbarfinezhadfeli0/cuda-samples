# Documentation for Samples/5_Domain_Specific/Mandelbrot/CMakeLists.txt

## File Metadata

- **Path**: `Samples/5_Domain_Specific/Mandelbrot/CMakeLists.txt`
- **Type**: .txt
...
target_compile_features(Mandelbrot PRIVATE cxx_std_17 cuda_std_17)
    ...
    message(STATUS "OpenGL not found - will not build sample 'Mandelbrot'")
endif()
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/Mandelbrot/CMakeLists.txt`.
