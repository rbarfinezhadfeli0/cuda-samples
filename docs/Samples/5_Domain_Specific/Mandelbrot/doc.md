# Documentation for Folder `Samples/5_Domain_Specific/Mandelbrot/`
...
- [Mandelbrot.cpp](./Mandelbrot.cpp_docs.md): C++ source code
- [Mandelbrot_cuda.cu](./Mandelbrot_cuda.cu_docs.md): CUDA kernel implementation
- [Mandelbrot_gold.cpp](./Mandelbrot_gold.cpp_docs.md): C++ source code
