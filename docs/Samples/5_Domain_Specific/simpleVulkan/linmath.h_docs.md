# Documentation: Samples/5_Domain_Specific/simpleVulkan/linmath.h
---
## File Metadata
- **Path**: `Samples/5_Domain_Specific/simpleVulkan/linmath.h`
- **Filename**: `linmath.h`
- **Language**: h
- **Size**: 15287 bytes
- **Lines**: 580
...
---
## High-Level Overview
This file is a h source file with 51 function(s) in the CUDA Samples repository.
...
- **LINMATH_H**: `#define _USE_MATH_DEFINES`
- **degreesToRadians**: ``
- **radiansToDegrees**: ``
- **quat_norm**: `vec4_norm`
...
- Function in Samples/5_Domain_Specific/simpleVulkan/linmath.h
