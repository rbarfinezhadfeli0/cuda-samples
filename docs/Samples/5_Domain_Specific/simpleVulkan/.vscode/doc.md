# Documentation for Folder `Samples/5_Domain_Specific/simpleVulkan/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/simpleVulkan/`.
...
- **Parent**: [Samples/5_Domain_Specific/simpleVulkan/](./../doc.md)
