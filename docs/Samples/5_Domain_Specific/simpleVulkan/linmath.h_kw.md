# Keywords: Samples/5_Domain_Specific/simpleVulkan/linmath.h
---
...
- **Type**: macro
- **File**: [Samples/5_Domain_Specific/simpleVulkan/linmath.h](./linmath.h_docs.md)
...
### _USE_MATH_DEFINES {#usemathdefines}

- **Type**: macro
- **File**: [Samples/5_Domain_Specific/simpleVulkan/linmath.h](./linmath.h_docs.md)
- **Context**: `#define _USE_MATH_DEFINES
#include <math.h>

// Converts degrees to radians.
#define degreesToRadian`
