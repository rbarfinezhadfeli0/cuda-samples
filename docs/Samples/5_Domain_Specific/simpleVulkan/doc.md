# Documentation for Folder `Samples/5_Domain_Specific/simpleVulkan/`
...
- [SineWaveSimulation.cu](./SineWaveSimulation.cu_docs.md): CUDA kernel implementation
- [VulkanBaseApp.cpp](./VulkanBaseApp.cpp_docs.md): C++ source code
