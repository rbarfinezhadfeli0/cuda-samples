# Documentation for Folder `Samples/5_Domain_Specific/bicubicTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/bicubicTexture/`.
...
- **Parent**: [Samples/5_Domain_Specific/bicubicTexture/](./../doc.md)
