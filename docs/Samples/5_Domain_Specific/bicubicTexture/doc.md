# Documentation for Folder `Samples/5_Domain_Specific/bicubicTexture/`
...
- [bicubicTexture.cpp](./bicubicTexture.cpp_docs.md): C++ source code
- [bicubicTexture_cuda.cu](./bicubicTexture_cuda.cu_docs.md): CUDA kernel implementation
