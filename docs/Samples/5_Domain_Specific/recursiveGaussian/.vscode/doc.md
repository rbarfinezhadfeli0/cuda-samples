# Documentation for Folder `Samples/5_Domain_Specific/recursiveGaussian/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/recursiveGaussian/`.
...
- **Parent**: [Samples/5_Domain_Specific/recursiveGaussian/](./../doc.md)
