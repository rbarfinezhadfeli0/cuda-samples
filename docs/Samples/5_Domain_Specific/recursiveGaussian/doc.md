# Documentation for Folder `Samples/5_Domain_Specific/recursiveGaussian/`
...
- [recursiveGaussian.cpp](./recursiveGaussian.cpp_docs.md): C++ source code
- [recursiveGaussian_cuda.cu](./recursiveGaussian_cuda.cu_docs.md): CUDA kernel implementation
