# Documentation for Folder `Samples/5_Domain_Specific/fluidsGL/`
...
- [fluidsGL.cpp](./fluidsGL.cpp_docs.md): C++ source code
- [fluidsGL_kernels.cu](./fluidsGL_kernels.cu_docs.md): CUDA kernel implementation
