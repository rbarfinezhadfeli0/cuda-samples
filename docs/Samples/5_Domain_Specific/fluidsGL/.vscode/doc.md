# Documentation for Folder `Samples/5_Domain_Specific/fluidsGL/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/fluidsGL/`.
...
- **Parent**: [Samples/5_Domain_Specific/fluidsGL/](./../doc.md)
