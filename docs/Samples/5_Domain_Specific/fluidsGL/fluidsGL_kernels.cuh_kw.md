# Keywords: Samples/5_Domain_Specific/fluidsGL/fluidsGL_kernels.cuh
---
...
### __STABLEFLUIDS_KERNELS_CUH_ {#stablefluidskernelscuh}

- **Type**: macro
- **File**: [Samples/5_Domain_Specific/fluidsGL/fluidsGL_kernels.cuh](./fluidsGL_kernels.cuh_docs.md)
- **Context**: `#define __STABLEFLUIDS_KERNELS_CUH_

#include "defines.h"

// Vector data type used to velocity and `
