# Documentation for Samples/5_Domain_Specific/convolutionFFT2D/README.md

## File Metadata

- **Path**: `Samples/5_Domain_Specific/convolutionFFT2D/README.md`
- **Type**: .md
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/convolutionFFT2D/README.md`.
