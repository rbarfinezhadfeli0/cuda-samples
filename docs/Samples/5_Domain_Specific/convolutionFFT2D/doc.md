# Documentation for Folder `Samples/5_Domain_Specific/convolutionFFT2D/`
...
- [convolutionFFT2D.cu](./convolutionFFT2D.cu_docs.md): CUDA kernel implementation
- [convolutionFFT2D_gold.cpp](./convolutionFFT2D_gold.cpp_docs.md): C++ source code
