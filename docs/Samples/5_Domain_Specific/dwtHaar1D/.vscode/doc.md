# Documentation for Folder `Samples/5_Domain_Specific/dwtHaar1D/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/dwtHaar1D/`.
...
- **Parent**: [Samples/5_Domain_Specific/dwtHaar1D/](./../doc.md)
