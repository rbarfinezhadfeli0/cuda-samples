# Documentation for Folder `Samples/5_Domain_Specific/FDTD3d/src/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/FDTD3d/`.
...
- [FDTD3d.cpp](./FDTD3d.cpp_docs.md): C++ source code
- [FDTD3dGPU.cu](./FDTD3dGPU.cu_docs.md): CUDA kernel implementation
- [FDTD3dReference.cpp](./FDTD3dReference.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/5_Domain_Specific/FDTD3d/](./../doc.md)
