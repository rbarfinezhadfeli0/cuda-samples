# Documentation for Folder `Samples/5_Domain_Specific/MonteCarloMultiGPU/`
...
- [MonteCarloMultiGPU.cpp](./MonteCarloMultiGPU.cpp_docs.md): C++ source code
- [MonteCarlo_gold.cpp](./MonteCarlo_gold.cpp_docs.md): C++ source code
- [MonteCarlo_kernel.cu](./MonteCarlo_kernel.cu_docs.md): CUDA kernel implementation
