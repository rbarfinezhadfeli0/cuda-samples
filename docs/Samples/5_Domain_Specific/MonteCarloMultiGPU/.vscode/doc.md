# Documentation for Folder `Samples/5_Domain_Specific/MonteCarloMultiGPU/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/MonteCarloMultiGPU/`.
...
- **Parent**: [Samples/5_Domain_Specific/MonteCarloMultiGPU/](./../doc.md)
