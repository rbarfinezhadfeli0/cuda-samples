# Documentation for Folder `Samples/5_Domain_Specific/HSOpticalFlow/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/HSOpticalFlow/`.
...
- **Parent**: [Samples/5_Domain_Specific/HSOpticalFlow/](./../doc.md)
