# Documentation for Folder `Samples/5_Domain_Specific/HSOpticalFlow/`
...
- [flowCUDA.cu](./flowCUDA.cu_docs.md): CUDA kernel implementation
- [flowGold.cpp](./flowGold.cpp_docs.md): C++ source code
