# Documentation for Folder `Samples/5_Domain_Specific/smokeParticles/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/`.
...
- [GLSLProgram.cpp](./GLSLProgram.cpp_docs.md): C++ source code
- [ParticleSystem.cpp](./ParticleSystem.cpp_docs.md): C++ source code
- [ParticleSystem_cuda.cu](./ParticleSystem_cuda.cu_docs.md): CUDA kernel implementation
- [README.md](./README.md_docs.md): Sample documentation
- [SmokeRenderer.cpp](./SmokeRenderer.cpp_docs.md): C++ source code
- [SmokeShaders.cpp](./SmokeShaders.cpp_docs.md): C++ source code
- [framebufferObject.cpp](./framebufferObject.cpp_docs.md): C++ source code
- [particleDemo.cpp](./particleDemo.cpp_docs.md): C++ source code
- [renderbuffer.cpp](./renderbuffer.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/5_Domain_Specific/](./../doc.md)
