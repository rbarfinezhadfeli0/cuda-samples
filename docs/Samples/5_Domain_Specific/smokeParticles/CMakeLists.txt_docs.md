# Documentation for Samples/5_Domain_Specific/smokeParticles/CMakeLists.txt

## File Metadata

- **Path**: `Samples/5_Domain_Specific/smokeParticles/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/smokeParticles/CMakeLists.txt`.
