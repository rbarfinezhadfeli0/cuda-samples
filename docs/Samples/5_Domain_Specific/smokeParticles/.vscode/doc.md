# Documentation for Folder `Samples/5_Domain_Specific/smokeParticles/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/smokeParticles/`.
...
- **Parent**: [Samples/5_Domain_Specific/smokeParticles/](./../doc.md)
