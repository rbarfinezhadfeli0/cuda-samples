# Documentation for Folder `Samples/5_Domain_Specific/postProcessGL/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/postProcessGL/`.
...
- **Parent**: [Samples/5_Domain_Specific/postProcessGL/](./../doc.md)
