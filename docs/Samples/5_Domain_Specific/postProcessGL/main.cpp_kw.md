# Keywords: Samples/5_Domain_Specific/postProcessGL/main.cpp
---
...
- **Type**: identifier
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `s = 0;
...
- **Type**: identifier
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `tes the use of CUDA/OpenGL interoperability
  `
...
- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void createDepthBuffer(GLuint *depth, unsigned int size_x, unsigned int size_y)
{`
...
- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void createFramebuffer(GLuint *fbo, GLuint color, GLuint depth)
{`
...
### createTextureSrc {#createtexturesrc}

- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void createTextureSrc(GLuint *tex_screen, unsigned int size_x, unsigned int size_y)
{`
...
### deleteDepthBuffer {#deletedepthbuffer}

- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void deleteDepthBuffer(GLuint *depth)
{`
...
- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void deleteFramebuffer(GLuint *fbo)
{`
...
- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void process(int width, int height, int radius)
{`
...
- **Type**: function
- **File**: [Samples/5_Domain_Specific/postProcessGL/main.cpp](./main.cpp_docs.md)
- **Context**: `void renderScene(bool colorScale)
{`
