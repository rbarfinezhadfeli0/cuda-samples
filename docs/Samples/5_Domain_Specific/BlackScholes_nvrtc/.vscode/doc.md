# Documentation for Folder `Samples/5_Domain_Specific/BlackScholes_nvrtc/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/BlackScholes_nvrtc/`.
...
- **Parent**: [Samples/5_Domain_Specific/BlackScholes_nvrtc/](./../doc.md)
