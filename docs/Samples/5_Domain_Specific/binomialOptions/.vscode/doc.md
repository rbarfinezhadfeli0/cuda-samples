# Documentation for Folder `Samples/5_Domain_Specific/binomialOptions/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/binomialOptions/`.
...
- **Parent**: [Samples/5_Domain_Specific/binomialOptions/](./../doc.md)
