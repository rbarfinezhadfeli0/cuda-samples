# Documentation for Folder `Samples/5_Domain_Specific/p2pBandwidthLatencyTest/`
...
- [p2pBandwidthLatencyTest.cu](./p2pBandwidthLatencyTest.cu_docs.md): CUDA kernel implementation
