# Documentation for Folder `Samples/5_Domain_Specific/p2pBandwidthLatencyTest/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/p2pBandwidthLatencyTest/`.
...
- **Parent**: [Samples/5_Domain_Specific/p2pBandwidthLatencyTest/](./../doc.md)
