# Documentation for Folder `Samples/5_Domain_Specific/volumeRender/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/volumeRender/`.
...
- **Parent**: [Samples/5_Domain_Specific/volumeRender/](./../doc.md)
