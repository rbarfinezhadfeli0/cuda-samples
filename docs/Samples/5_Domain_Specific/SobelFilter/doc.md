# Documentation for Folder `Samples/5_Domain_Specific/SobelFilter/`
...
- [SobelFilter.cpp](./SobelFilter.cpp_docs.md): C++ source code
- [SobelFilter_kernels.cu](./SobelFilter_kernels.cu_docs.md): CUDA kernel implementation
