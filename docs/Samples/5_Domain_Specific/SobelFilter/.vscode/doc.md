# Documentation for Folder `Samples/5_Domain_Specific/SobelFilter/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/SobelFilter/`.
...
- **Parent**: [Samples/5_Domain_Specific/SobelFilter/](./../doc.md)
