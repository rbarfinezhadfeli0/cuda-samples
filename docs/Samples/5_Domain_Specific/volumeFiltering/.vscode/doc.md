# Documentation for Folder `Samples/5_Domain_Specific/volumeFiltering/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/volumeFiltering/`.
...
- **Parent**: [Samples/5_Domain_Specific/volumeFiltering/](./../doc.md)
