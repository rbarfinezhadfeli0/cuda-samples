# Documentation for Folder `Samples/5_Domain_Specific/volumeFiltering/`
...
- [volume.cpp](./volume.cpp_docs.md): C++ source code
- [volumeFilter_kernel.cu](./volumeFilter_kernel.cu_docs.md): CUDA kernel implementation
- [volumeFiltering.cpp](./volumeFiltering.cpp_docs.md): C++ source code
- [volumeRender_kernel.cu](./volumeRender_kernel.cu_docs.md): CUDA kernel implementation
