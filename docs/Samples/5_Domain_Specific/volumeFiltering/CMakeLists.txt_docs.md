# Documentation for Samples/5_Domain_Specific/volumeFiltering/CMakeLists.txt

## File Metadata

- **Path**: `Samples/5_Domain_Specific/volumeFiltering/CMakeLists.txt`
- **Type**: .txt
...
if(${OpenGL_FOUND})
    ...
    message(STATUS "OpenGL not found - will not build sample 'volumeFiltering'")
endif()
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/volumeFiltering/CMakeLists.txt`.
