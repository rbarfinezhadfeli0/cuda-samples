# Documentation for Folder `Samples/5_Domain_Specific/quasirandomGenerator_nvrtc/`
...
- [quasirandomGenerator.cpp](./quasirandomGenerator.cpp_docs.md): C++ source code
- [quasirandomGenerator_gold.cpp](./quasirandomGenerator_gold.cpp_docs.md): C++ source code
- [quasirandomGenerator_kernel.cu](./quasirandomGenerator_kernel.cu_docs.md): CUDA kernel implementation
