# Documentation for Samples/5_Domain_Specific/quasirandomGenerator_nvrtc/CMakeLists.txt

## File Metadata

- **Path**: `Samples/5_Domain_Specific/quasirandomGenerator_nvrtc/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/quasirandomGenerator_nvrtc/CMakeLists.txt`.
