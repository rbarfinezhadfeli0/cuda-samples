# Documentation for Samples/5_Domain_Specific/simpleGL/CMakeLists.txt

## File Metadata

- **Path**: `Samples/5_Domain_Specific/simpleGL/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/5_Domain_Specific/simpleGL
- **Binary**: No
...
if(${OpenGL_FOUND})
    if (${GLUT_FOUND})
        ...
        message(STATUS "GLUT not found - will not build sample 'simpleGL'")
    endif()
else()
    message(STATUS "OpenGL not found - will not build sample 'simpleGL'")
endif()
...
This file is part of the CUDA Samples repository, located at `Samples/5_Domain_Specific/simpleGL/CMakeLists.txt`.
