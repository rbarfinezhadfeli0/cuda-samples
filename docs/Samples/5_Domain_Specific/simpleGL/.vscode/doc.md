# Documentation for Folder `Samples/5_Domain_Specific/simpleGL/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/simpleGL/`.
...
- **Parent**: [Samples/5_Domain_Specific/simpleGL/](./../doc.md)
