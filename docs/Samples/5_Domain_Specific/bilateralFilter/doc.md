# Documentation for Folder `Samples/5_Domain_Specific/bilateralFilter/`
...
- [bilateralFilter.cpp](./bilateralFilter.cpp_docs.md): C++ source code
- [bilateralFilter_cpu.cpp](./bilateralFilter_cpu.cpp_docs.md): C++ source code
- [bilateral_kernel.cu](./bilateral_kernel.cu_docs.md): CUDA kernel implementation
- [bmploader.cpp](./bmploader.cpp_docs.md): C++ source code
