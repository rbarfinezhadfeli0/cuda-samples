# Documentation for Folder `Samples/5_Domain_Specific/bilateralFilter/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/bilateralFilter/`.
...
- **Parent**: [Samples/5_Domain_Specific/bilateralFilter/](./../doc.md)
