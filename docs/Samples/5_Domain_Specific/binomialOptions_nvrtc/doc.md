# Documentation for Folder `Samples/5_Domain_Specific/binomialOptions_nvrtc/`
...
- [binomialOptions.cpp](./binomialOptions.cpp_docs.md): C++ source code
- [binomialOptions_gold.cpp](./binomialOptions_gold.cpp_docs.md): C++ source code
- [binomialOptions_gpu.cpp](./binomialOptions_gpu.cpp_docs.md): C++ source code
- [binomialOptions_kernel.cu](./binomialOptions_kernel.cu_docs.md): CUDA kernel implementation
