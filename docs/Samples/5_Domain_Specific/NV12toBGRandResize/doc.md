# Documentation for Folder `Samples/5_Domain_Specific/NV12toBGRandResize/`
...
- [bgr_resize.cu](./bgr_resize.cu_docs.md): CUDA kernel implementation
- [nv12_resize.cu](./nv12_resize.cu_docs.md): CUDA kernel implementation
- [nv12_to_bgr_planar.cu](./nv12_to_bgr_planar.cu_docs.md): CUDA kernel implementation
- [resize_convert_main.cpp](./resize_convert_main.cpp_docs.md): C++ source code
- [utils.cu](./utils.cu_docs.md): CUDA kernel implementation
