# Documentation for Folder `Samples/5_Domain_Specific/NV12toBGRandResize/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/5_Domain_Specific/NV12toBGRandResize/`.
...
- **Parent**: [Samples/5_Domain_Specific/NV12toBGRandResize/](./../doc.md)
