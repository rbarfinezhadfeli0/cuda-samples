# Documentation for Folder `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/src/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/`.
...
- [piestimator.cu](./piestimator.cu_docs.md): CUDA kernel implementation
...
- **Parent**: [Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/](./../doc.md)
