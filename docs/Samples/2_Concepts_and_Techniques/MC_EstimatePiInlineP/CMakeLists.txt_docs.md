# Documentation for Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/CMakeLists.txt

## File Metadata

- **Path**: `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineP/CMakeLists.txt`.
