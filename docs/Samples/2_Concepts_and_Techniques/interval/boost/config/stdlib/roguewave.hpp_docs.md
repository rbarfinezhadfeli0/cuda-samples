# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/roguewave.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/roguewave.hpp`
- **Filename**: `roguewave.hpp`
- **Language**: hpp
- **Size**: 5359 bytes
- **Lines**: 180
...
//
#if defined(_RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || defined(RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) \
    || (BOOST_RWSTD_VER < 0x020000)
...
- **BOOST_RWSTD_VER**: `0x010000`
- **BOOST_RWSTD_VER**: `(_RWSTD_VER << 8)`
- **BOOST_RWSTD_VER**: `_RWSTD_VER`
- **BOOST_STDLIB**: `"Rogue Wave standard library version (Unknown version)"`
- **BOOST_STDLIB**: `"Rogue Wave standard library version " BOOST_STRINGIZE(_RWSTD_VER)`
- **BOOST_STDLIB**: `"Apache STDCXX standard library version " _RWSTD_VER_STR`
- **BOOST_STDLIB**: `"Apache STDCXX standard library version " BOOST_STRINGIZE(_RWSTD_VER)`
- **BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS**: `#endif`
- **BOOST_NO_LONG_LONG_NUMERIC_LIMITS**: `#endif`
- **BOOST_NO_MS_INT64_NUMERIC_LIMITS**: `#endif`
- **BOOST_NO_STD_ITERATOR**: `#endif`
- **BOOST_NO_STD_ITERATOR_TRAITS**: `#endif`
- **BOOST_NO_AUTO_PTR**: `#define BOOST_NO_STRINGSTREAM`
- **BOOST_NO_STD_ALLOCATOR**: `#define BOOST_NO_STD_LOCALE`
...
- **BOOST_NO_STD_DISTANCE**: `#endif`
- **BOOST_NO_STD_OUTPUT_ITERATOR_ASSIGN**: `#endif`
- **__HP_TC1_MAKE_PAIR**: `#endif`
- **_HP_INSTANTIATE_STD2_VL**: `#endif`
