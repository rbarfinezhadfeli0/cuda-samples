# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/msl.hpp
---
## File Metadata
...
- **BOOST_HAS_HASH**: `#define BOOST_STD_EXTENSION_NAMESPACE Metrowerks`
- **BOOST_HAS_SLIST**: `#if __MSL_CPP__ < 0x6209`
- **BOOST_NO_STD_MESSAGES**: `#endif`
- **BOOST_HAS_STDINT_H**: `#if !defined(__PALMOS_TRAPS__)`
...
- **BOOST_STDLIB**: `"Metrowerks Standard Library version " BOOST_STRINGIZE(__MSL_CPP__)`
