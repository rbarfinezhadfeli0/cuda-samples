# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/stlport.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/stlport.hpp`
- **Filename**: `stlport.hpp`
- **Language**: hpp
- **Size**: 7602 bytes
- **Lines**: 238
...
//
#if defined(__STL_NO_IOSTREAMS) || defined(__STL_NO_NEW_IOSTREAMS) || defined(_STLP_NO_IOSTREAMS) \
    || defined(_STLP_NO_NEW_IOSTREAMS)
...
#if !(_STLPORT_VERSION >= 0x500) && !defined(_STLP_OWN_IOSTREAMS) && defined(_STLP_USE_NAMESPACES) \
...
//
#if (defined(__STL_IMPORT_VENDOR_CSTD) || defined(__STL_USE_OWN_NAMESPACE) || defined(_STLP_IMPORT_VENDOR_CSTD) \
...
- **BOOST_NO_STRINGSTREAM**: `#endif`
- **BOOST_NO_STD_LOCALE**: `#define BOOST_NO_STRINGSTREAM`
- **BOOST_NO_STD_LOCALE**: `#endif`
- **BOOST_NO_STD_LOCALE**: `#endif`
- **BOOST_NO_STD_UNORDERED**: `#endif`
- **BOOST_HAS_TR1_UNORDERED_SET**: `#define BOOST_HAS_TR1_UNORDERED_MAP`
- **BOOST_NO_TEMPLATED_ITERATOR_CONSTRUCTORS**: `#define BOOST_NO_STD_ALLOCATOR`
- **BOOST_HAS_PARTIAL_STD_ALLOCATOR**: `#if !defined(_STLP_MEMBER_TEMPLATE_CLASSES) || defined(_STLP_DONT_SUPPORT_REBIND_MEMBER_TEMPLATE)`
- **BOOST_NO_STD_ALLOCATOR**: `#endif`
- **BOOST_NO_STD_ALLOCATOR**: `#endif`
- **BOOST_NO_STD_WSTRING**: `#endif`
- **BOOST_NO_STD_WSTREAMBUF**: `#endif`
- **BOOST_HAS_HASH**: `#define BOOST_HAS_SLIST`
- **BOOST_NO_STDC_NAMESPACE**: `#define BOOST_NO_EXCEPTION_STD_NAMESPACE`
- **BOOST_NO_STD_USE_FACET**: `#define BOOST_HAS_STLP_USE_FACET`
