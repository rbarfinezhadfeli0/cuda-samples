# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/sgi.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/stdlib/sgi.hpp`
- **Filename**: `sgi.hpp`
- **Language**: hpp
- **Size**: 3953 bytes
- **Lines**: 133
...
- **BOOST_NO_LIMITS**: `// Note: <boost/limits.hpp> will provide compile-time constants`
- **BOOST_NO_STD_WSTRING**: `#endif`
- **BOOST_NO_STD_ITERATOR**: `#endif`
- **BOOST_HAS_SGI_TYPE_TRAITS**: `//  C++0x headers not yet implemented`
...
- **BOOST_STDLIB**: `"SGI standard library"`
