# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/platform/hpux.hpp
---
## File Metadata
...
- **BOOST_PLATFORM**: `"HP-UX"`
- **BOOST_HAS_STDINT_H**: `#endif`
- **BOOST_NO_SWPRINTF**: `#endif`
- **BOOST_NO_CWCTYPE**: `#endif`
- **BOOST_DISABLE_THREADS**: `#elif !defined(BOOST_DISABLE_THREADS)`
- **BOOST_HAS_THREADS**: `#define BOOST_HAS_PTHREADS`
