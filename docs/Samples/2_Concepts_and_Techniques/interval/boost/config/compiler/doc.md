# Documentation for Folder `Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/interval/boost/config/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/interval/boost/config/](./../doc.md)
