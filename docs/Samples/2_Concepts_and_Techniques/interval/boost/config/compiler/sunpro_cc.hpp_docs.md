# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/sunpro_cc.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/sunpro_cc.hpp`
- **Filename**: `sunpro_cc.hpp`
- **Language**: hpp
- **Size**: 3818 bytes
- **Lines**: 131
...
- **BOOST_NO_MEMBER_TEMPLATES**: `#define BOOST_NO_FUNCTION_TEMPLATE_ORDERING`
- **BOOST_NO_INCLASS_MEMBER_INITIALIZATION**: `// Although sunpro 5.2 supports the syntax for`
- **BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION**: `#endif`
- **BOOST_NO_INCLASS_MEMBER_INITIALIZATION**: `// SunPro 5.3 has better support for partial specialization,`
- **BOOST_NO_INTEGRAL_INT64_T**: `#endif`
- **BOOST_NO_TEMPLATE_TEMPLATES**: `// see http://lists.boost.org/MailArchives/boost/msg47184.php`
- **BOOST_NO_INCLASS_MEMBER_INITIALIZATION**: `#define BOOST_NO_SFINAE`
- **BOOST_NO_ARRAY_TYPE_SPECIALIZATIONS**: `#endif`
- **BOOST_NO_IS_ABSTRACT**: `#endif`
- **BOOST_NO_TWO_PHASE_NAME_LOOKUP**: `#define BOOST_NO_ADL_BARRIER`
...
- **BOOST_COMPILER**: `"Sun compiler version " BOOST_STRINGIZE(__SUNPRO_CC)`
