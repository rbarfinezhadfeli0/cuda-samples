# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/mpw.hpp
---
## File Metadata
...
- **BOOST_COMPILER**: `"MPW SCpp version " BOOST_STRINGIZE(__SC__)`
- **BOOST_COMPILER**: `"MPW MrCpp version " BOOST_STRINGIZE(__MRC__)`
- **BOOST_NO_CV_SPECIALIZATIONS**: `#define BOOST_NO_DEPENDENT_NESTED_DERIVATIONS`
- **BOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS**: `#define BOOST_NO_INCLASS_MEMBER_INITIALIZATION`
- **BOOST_NO_INTRINSIC_WCHAR_T**: `#define BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION`
- **BOOST_NO_USING_TEMPLATE**: `#define BOOST_NO_CWCHAR`
- **BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS**: `#define BOOST_NO_STD_ALLOCATOR /* actually a bug with const reference overloading */`
