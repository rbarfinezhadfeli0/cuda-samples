# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/common_edg.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/compiler/common_edg.hpp`
- **Filename**: `common_edg.hpp`
- **Language**: hpp
- **Size**: 2651 bytes
- **Lines**: 95
...
- **BOOST_NO_INTEGRAL_INT64_T**: `#define BOOST_NO_SFINAE`
- **BOOST_NO_VOID_RETURNS**: `#endif`
- **BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP**: `#endif`
- **BOOST_NO_TEMPLATE_TEMPLATES**: `#endif`
