# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/auto_link.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/auto_link.hpp`
- **Filename**: `auto_link.hpp`
- **Language**: hpp
- **Size**: 9877 bytes
- **Lines**: 363
...
- **BOOST_STRINGIZE**: ``
- **BOOST_DO_STRINGIZE**: ``
- **BOOST_LIB_TOOLSET**: `"evc4"`
- **BOOST_LIB_TOOLSET**: `"vc6"`
- **BOOST_LIB_TOOLSET**: `"vc7"`
- **BOOST_LIB_TOOLSET**: `"vc71"`
- **BOOST_LIB_TOOLSET**: `"vc80"`
- **BOOST_LIB_TOOLSET**: `"vc90"`
- **BOOST_LIB_TOOLSET**: `"vc100"`
- **BOOST_LIB_TOOLSET**: `"bcb"`
- **BOOST_LIB_TOOLSET**: `"iw"`
- **BOOST_LIB_TOOLSET**: `"cw8"`
- **BOOST_LIB_TOOLSET**: `"cw9"`
- **BOOST_LIB_THREAD_OPT**: `"-mt"`
- **BOOST_LIB_THREAD_OPT**: `#endif`
...
- **BOOST_LIB_RT_OPT**: `"-sd"`
- **BOOST_LIB_RT_OPT**: `"-s"`
- **BOOST_LIB_PREFIX**: `#elif defined(BOOST_DYN_LINK)`
