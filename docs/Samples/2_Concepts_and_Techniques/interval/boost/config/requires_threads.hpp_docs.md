# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/config/requires_threads.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/config/requires_threads.hpp`
- **Filename**: `requires_threads.hpp`
- **Language**: hpp
- **Size**: 3506 bytes
- **Lines**: 101
...
- **BOOST_CONFIG_REQUIRES_THREADS_HPP**: `#ifndef BOOST_CONFIG_HPP`
- **_MSC_VER**: `#error \`
