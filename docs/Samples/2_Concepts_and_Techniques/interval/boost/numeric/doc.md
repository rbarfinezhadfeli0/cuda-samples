# Documentation for Folder `Samples/2_Concepts_and_Techniques/interval/boost/numeric/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/interval/boost/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/interval/boost/](./../doc.md)
