# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/detail/alpha_rounding_control.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/detail/alpha_rounding_control.hpp`
- **Filename**: `alpha_rounding_control.hpp`
- **Language**: hpp
- **Size**: 3581 bytes
- **Lines**: 111
 ...
 *
 * Copyright 2005 Felix Hfling, Guillaume Melquiond
 *
...
struct alpha_rounding_control
{
    ...
    static void set_rounding_mode(const rounding_mode mode) { __asm__ __volatile__("mt_fpcr %0" : : "f"(mode)); }

    static void get_rounding_mode(rounding_mode &mode) { __asm__ __volatile__("mf_fpcr %0" : "=f"(mode)); }
...
template <> struct rounding_control<long double> : detail::alpha_rounding_control
{
...
---
## High-Level Overview
This file is a hpp source file with 16 function(s) and 2 class/struct definition(s) in the CUDA Samples repository.
...
- **BOOST_NUMERIC_INTERVAL_DETAIL_ALPHA_ROUNDING_CONTROL_HPP**: `#if !defined(alpha) && !defined(__alpha__)`

### Functions
#### `void set_rounding_mode(const rounding_mode mode)`
- Function in Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/detail/alpha_rounding_control.hpp
...
### Classes / Structures
#### `struct alpha_rounding_control`
- Defined in Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/detail/alpha_rounding_control.hpp
