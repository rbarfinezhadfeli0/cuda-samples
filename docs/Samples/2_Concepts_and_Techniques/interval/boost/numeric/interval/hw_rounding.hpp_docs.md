# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/hw_rounding.hpp
---
## File Metadata
- **Path**: `Samples/2_Concepts_and_Techniques/interval/boost/numeric/interval/hw_rounding.hpp`
- **Filename**: `hw_rounding.hpp`
- **Language**: hpp
- **Size**: 2255 bytes
- **Lines**: 68
...
- **BOOST_NUMERIC_INTERVAL_HW_ROUNDING_HPP**: `#include <boost/numeric/interval/rounded_arith.hpp>`
- **BOOST_NUMERIC_INTERVAL_NO_HARDWARE**: `// define appropriate specialization of rounding_control for built-in types`
