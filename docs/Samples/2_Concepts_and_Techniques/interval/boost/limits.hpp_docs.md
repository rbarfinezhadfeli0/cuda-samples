# Documentation: Samples/2_Concepts_and_Techniques/interval/boost/limits.hpp
---
## File Metadata
...
---
## High-Level Overview
This file is a hpp source file with 16 function(s) in the CUDA Samples repository.
...
- **BOOST_LIMITS**: `#include <boost/config.hpp>`
- **BOOST_LLT**: `__int64`
- **BOOST_ULLT**: `unsigned __int64`
- **BOOST_LLT**: `::boost::long_long_type`
- **BOOST_ULLT**: `::boost::ulong_long_type`

### Functions
#### `min BOOST_PREVENT_MACRO_SUBSTITUTION()`
- Function in Samples/2_Concepts_and_Techniques/interval/boost/limits.hpp
