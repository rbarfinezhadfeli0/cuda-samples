# Documentation for Samples/2_Concepts_and_Techniques/interval/CMakeLists.txt

## File Metadata

- **Path**: `Samples/2_Concepts_and_Techniques/interval/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/interval/CMakeLists.txt`.
