# Documentation for Folder `Samples/2_Concepts_and_Techniques/eigenvalues/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/`.
...
- [bisect_large.cu](./bisect_large.cu_docs.md): CUDA kernel implementation
- [bisect_small.cu](./bisect_small.cu_docs.md): CUDA kernel implementation
- [bisect_util.cu](./bisect_util.cu_docs.md): CUDA kernel implementation
- [gerschgorin.cpp](./gerschgorin.cpp_docs.md): C++ source code
- [main.cu](./main.cu_docs.md): CUDA kernel implementation
- [matlab.cpp](./matlab.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/2_Concepts_and_Techniques/](./../doc.md)
