# Documentation for Folder `Samples/2_Concepts_and_Techniques/shfl_scan/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/shfl_scan/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/shfl_scan/](./../doc.md)
