# Documentation for Folder `Samples/2_Concepts_and_Techniques/EGLStream_CUDA_Interop/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/EGLStream_CUDA_Interop/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/EGLStream_CUDA_Interop/](./../doc.md)
