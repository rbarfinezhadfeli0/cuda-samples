# Documentation for Samples/2_Concepts_and_Techniques/reduction/CMakeLists.txt

## File Metadata

- **Path**: `Samples/2_Concepts_and_Techniques/reduction/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/2_Concepts_and_Techniques/reduction
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/reduction/CMakeLists.txt`.
