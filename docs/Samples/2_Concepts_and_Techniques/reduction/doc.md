# Documentation for Folder `Samples/2_Concepts_and_Techniques/reduction/`
...
- [reduction.cpp](./reduction.cpp_docs.md): C++ source code
- [reduction_kernel.cu](./reduction_kernel.cu_docs.md): CUDA kernel implementation
