# Documentation for Folder `Samples/2_Concepts_and_Techniques/reduction/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/reduction/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/reduction/](./../doc.md)
