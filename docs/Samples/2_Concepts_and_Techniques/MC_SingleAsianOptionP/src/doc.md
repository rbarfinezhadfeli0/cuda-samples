# Documentation for Folder `Samples/2_Concepts_and_Techniques/MC_SingleAsianOptionP/src/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/MC_SingleAsianOptionP/`.
...
- [pricingengine.cu](./pricingengine.cu_docs.md): CUDA kernel implementation
- [test.cpp](./test.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/2_Concepts_and_Techniques/MC_SingleAsianOptionP/](./../doc.md)
