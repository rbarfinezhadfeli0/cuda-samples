# Documentation for Folder `Samples/2_Concepts_and_Techniques/MC_EstimatePiQ/src/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/MC_EstimatePiQ/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/MC_EstimatePiQ/](./../doc.md)
