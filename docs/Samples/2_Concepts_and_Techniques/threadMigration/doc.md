# Documentation for Folder `Samples/2_Concepts_and_Techniques/threadMigration/`
...
- [threadMigration.cpp](./threadMigration.cpp_docs.md): C++ source code
- [threadMigration_kernel.cu](./threadMigration_kernel.cu_docs.md): CUDA kernel implementation
