# Documentation for Folder `Samples/2_Concepts_and_Techniques/convolutionTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/convolutionTexture/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/convolutionTexture/](./../doc.md)
