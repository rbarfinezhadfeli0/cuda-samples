# Documentation for Folder `Samples/2_Concepts_and_Techniques/convolutionTexture/`
...
- [convolutionTexture.cu](./convolutionTexture.cu_docs.md): CUDA kernel implementation
- [convolutionTexture_gold.cpp](./convolutionTexture_gold.cpp_docs.md): C++ source code
