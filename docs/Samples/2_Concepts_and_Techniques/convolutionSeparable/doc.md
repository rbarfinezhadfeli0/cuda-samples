# Documentation for Folder `Samples/2_Concepts_and_Techniques/convolutionSeparable/`
...
- [convolutionSeparable.cu](./convolutionSeparable.cu_docs.md): CUDA kernel implementation
- [convolutionSeparable_gold.cpp](./convolutionSeparable_gold.cpp_docs.md): C++ source code
