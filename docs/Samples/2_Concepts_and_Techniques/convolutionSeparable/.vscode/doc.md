# Documentation for Folder `Samples/2_Concepts_and_Techniques/convolutionSeparable/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/convolutionSeparable/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/convolutionSeparable/](./../doc.md)
