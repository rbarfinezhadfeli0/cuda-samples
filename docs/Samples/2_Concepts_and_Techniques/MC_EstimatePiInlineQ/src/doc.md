# Documentation for Folder `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineQ/src/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineQ/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/MC_EstimatePiInlineQ/](./../doc.md)
