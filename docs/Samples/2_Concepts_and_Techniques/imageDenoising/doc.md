# Documentation for Folder `Samples/2_Concepts_and_Techniques/imageDenoising/`
...
- [imageDenoising.cu](./imageDenoising.cu_docs.md): CUDA kernel implementation
- [imageDenoisingGL.cpp](./imageDenoisingGL.cpp_docs.md): C++ source code
