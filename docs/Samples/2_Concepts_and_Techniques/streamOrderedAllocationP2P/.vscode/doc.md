# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocationP2P/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/streamOrderedAllocationP2P/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/streamOrderedAllocationP2P/](./../doc.md)
