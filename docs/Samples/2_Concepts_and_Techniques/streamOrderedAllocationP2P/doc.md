# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocationP2P/`
...
- [streamOrderedAllocationP2P.cu](./streamOrderedAllocationP2P.cu_docs.md): CUDA kernel implementation
