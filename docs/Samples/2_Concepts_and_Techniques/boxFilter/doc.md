# Documentation for Folder `Samples/2_Concepts_and_Techniques/boxFilter/`
...
- [boxFilter.cpp](./boxFilter.cpp_docs.md): C++ source code
- [boxFilter_cpu.cpp](./boxFilter_cpu.cpp_docs.md): C++ source code
- [boxFilter_kernel.cu](./boxFilter_kernel.cu_docs.md): CUDA kernel implementation
