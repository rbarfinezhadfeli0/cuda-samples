# Documentation for Folder `Samples/2_Concepts_and_Techniques/inlinePTX_nvrtc/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/inlinePTX_nvrtc/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/inlinePTX_nvrtc/](./../doc.md)
