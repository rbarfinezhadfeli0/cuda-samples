# Documentation for Folder `Samples/2_Concepts_and_Techniques/inlinePTX_nvrtc/`
...
- [inlinePTX.cpp](./inlinePTX.cpp_docs.md): C++ source code
- [inlinePTX_kernel.cu](./inlinePTX_kernel.cu_docs.md): CUDA kernel implementation
