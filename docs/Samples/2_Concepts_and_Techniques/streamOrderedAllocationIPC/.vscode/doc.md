# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocationIPC/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/streamOrderedAllocationIPC/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/streamOrderedAllocationIPC/](./../doc.md)
