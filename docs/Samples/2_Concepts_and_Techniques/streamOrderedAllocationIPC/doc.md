# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocationIPC/`
...
- [streamOrderedAllocationIPC.cu](./streamOrderedAllocationIPC.cu_docs.md): CUDA kernel implementation
