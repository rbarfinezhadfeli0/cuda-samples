# Documentation for Folder `Samples/2_Concepts_and_Techniques/dct8x8/`
...
- [BmpUtil.cpp](./BmpUtil.cpp_docs.md): C++ source code
- [CMakeLists.txt](./CMakeLists.txt_docs.md): Build configuration
- [DCT8x8_Gold.cpp](./DCT8x8_Gold.cpp_docs.md): C++ source code
- [README.md](./README.md_docs.md): Sample documentation
- [dct8x8.cu](./dct8x8.cu_docs.md): CUDA kernel implementation
