# Documentation for Folder `Samples/2_Concepts_and_Techniques/segmentationTreeThrust/`
...
- [segmentationTree.cu](./segmentationTree.cu_docs.md): CUDA kernel implementation
