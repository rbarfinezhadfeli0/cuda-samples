# Documentation for Samples/2_Concepts_and_Techniques/segmentationTreeThrust/CMakeLists.txt

## File Metadata

- **Path**: `Samples/2_Concepts_and_Techniques/segmentationTreeThrust/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/segmentationTreeThrust/CMakeLists.txt`.
