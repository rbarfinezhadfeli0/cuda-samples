# Documentation for Folder `Samples/2_Concepts_and_Techniques/histogram/`
...
- [histogram256.cu](./histogram256.cu_docs.md): CUDA kernel implementation
- [histogram64.cu](./histogram64.cu_docs.md): CUDA kernel implementation
- [histogram_gold.cpp](./histogram_gold.cpp_docs.md): C++ source code
