# Documentation for Folder `Samples/2_Concepts_and_Techniques/scalarProd/`
...
- [scalarProd.cu](./scalarProd.cu_docs.md): CUDA kernel implementation
- [scalarProd_cpu.cpp](./scalarProd_cpu.cpp_docs.md): C++ source code
