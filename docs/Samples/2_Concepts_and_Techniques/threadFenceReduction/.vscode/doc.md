# Documentation for Folder `Samples/2_Concepts_and_Techniques/threadFenceReduction/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/threadFenceReduction/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/threadFenceReduction/](./../doc.md)
