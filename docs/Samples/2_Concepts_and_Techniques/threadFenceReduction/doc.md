# Documentation for Folder `Samples/2_Concepts_and_Techniques/threadFenceReduction/`
...
- [threadFenceReduction.cu](./threadFenceReduction.cu_docs.md): CUDA kernel implementation
