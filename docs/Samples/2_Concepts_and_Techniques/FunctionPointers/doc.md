# Documentation for Folder `Samples/2_Concepts_and_Techniques/FunctionPointers/`
...
- [FunctionPointers.cpp](./FunctionPointers.cpp_docs.md): C++ source code
- [FunctionPointers_kernels.cu](./FunctionPointers_kernels.cu_docs.md): CUDA kernel implementation
