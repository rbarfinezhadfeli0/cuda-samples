# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocation/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/streamOrderedAllocation/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/streamOrderedAllocation/](./../doc.md)
