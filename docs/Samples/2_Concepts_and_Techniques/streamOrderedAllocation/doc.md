# Documentation for Folder `Samples/2_Concepts_and_Techniques/streamOrderedAllocation/`
...
- [streamOrderedAllocation.cu](./streamOrderedAllocation.cu_docs.md): CUDA kernel implementation
