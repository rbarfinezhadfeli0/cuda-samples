# Documentation for Folder `Samples/2_Concepts_and_Techniques/EGLStream_CUDA_CrossGPU/`
...
- [cuda_consumer.cpp](./cuda_consumer.cpp_docs.md): C++ source code
- [cuda_producer.cpp](./cuda_producer.cpp_docs.md): C++ source code
- [eglstrm_common.cpp](./eglstrm_common.cpp_docs.md): C++ source code
- [kernel.cu](./kernel.cu_docs.md): CUDA kernel implementation
