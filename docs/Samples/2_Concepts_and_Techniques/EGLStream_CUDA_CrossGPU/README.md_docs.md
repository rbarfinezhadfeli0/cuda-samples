# Documentation for Samples/2_Concepts_and_Techniques/EGLStream_CUDA_CrossGPU/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/EGLStream_CUDA_CrossGPU/README.md`.
