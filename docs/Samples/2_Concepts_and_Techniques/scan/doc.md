# Documentation for Folder `Samples/2_Concepts_and_Techniques/scan/`
...
- [scan.cu](./scan.cu_docs.md): CUDA kernel implementation
- [scan_gold.cpp](./scan_gold.cpp_docs.md): C++ source code
