# Documentation for Samples/2_Concepts_and_Techniques/MC_EstimatePiP/CMakeLists.txt

## File Metadata

- **Path**: `Samples/2_Concepts_and_Techniques/MC_EstimatePiP/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/2_Concepts_and_Techniques/MC_EstimatePiP
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/2_Concepts_and_Techniques/MC_EstimatePiP/CMakeLists.txt`.
