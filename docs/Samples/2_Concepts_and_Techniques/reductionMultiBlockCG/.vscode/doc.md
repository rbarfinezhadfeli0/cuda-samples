# Documentation for Folder `Samples/2_Concepts_and_Techniques/reductionMultiBlockCG/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/2_Concepts_and_Techniques/reductionMultiBlockCG/`.
...
- **Parent**: [Samples/2_Concepts_and_Techniques/reductionMultiBlockCG/](./../doc.md)
