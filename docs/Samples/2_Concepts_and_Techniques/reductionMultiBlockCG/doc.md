# Documentation for Folder `Samples/2_Concepts_and_Techniques/reductionMultiBlockCG/`
...
- [reductionMultiBlockCG.cu](./reductionMultiBlockCG.cu_docs.md): CUDA kernel implementation
