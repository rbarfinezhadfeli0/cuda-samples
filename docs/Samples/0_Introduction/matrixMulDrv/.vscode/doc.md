# Documentation for Folder `Samples/0_Introduction/matrixMulDrv/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/matrixMulDrv/`.
...
- **Parent**: [Samples/0_Introduction/matrixMulDrv/](./../doc.md)
