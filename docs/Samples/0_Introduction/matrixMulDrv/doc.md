# Documentation for Folder `Samples/0_Introduction/matrixMulDrv/`
...
- [matrixMulDrv.cpp](./matrixMulDrv.cpp_docs.md): C++ source code
- [matrixMul_kernel.cu](./matrixMul_kernel.cu_docs.md): CUDA kernel implementation
