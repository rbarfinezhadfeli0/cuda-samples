# Documentation for Folder `Samples/0_Introduction/simpleAssert_nvrtc/`
...
- [simpleAssert.cpp](./simpleAssert.cpp_docs.md): C++ source code
- [simpleAssert_kernel.cu](./simpleAssert_kernel.cu_docs.md): CUDA kernel implementation
