# Documentation for Folder `Samples/0_Introduction/simpleOccupancy/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleOccupancy/`.
...
- **Parent**: [Samples/0_Introduction/simpleOccupancy/](./../doc.md)
