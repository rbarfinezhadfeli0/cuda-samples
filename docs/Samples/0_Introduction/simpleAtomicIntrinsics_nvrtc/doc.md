# Documentation for Folder `Samples/0_Introduction/simpleAtomicIntrinsics_nvrtc/`
...
- [simpleAtomicIntrinsics.cpp](./simpleAtomicIntrinsics.cpp_docs.md): C++ source code
