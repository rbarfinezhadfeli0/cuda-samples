# Documentation for Folder `Samples/0_Introduction/simpleAssert/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleAssert/`.
...
- **Parent**: [Samples/0_Introduction/simpleAssert/](./../doc.md)
