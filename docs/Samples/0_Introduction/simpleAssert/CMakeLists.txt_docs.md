# Documentation for Samples/0_Introduction/simpleAssert/CMakeLists.txt

## File Metadata

- **Path**: `Samples/0_Introduction/simpleAssert/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/simpleAssert/CMakeLists.txt`.
