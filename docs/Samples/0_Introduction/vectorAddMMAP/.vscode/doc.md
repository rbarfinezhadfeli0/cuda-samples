# Documentation for Folder `Samples/0_Introduction/vectorAddMMAP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/vectorAddMMAP/`.
...
- **Parent**: [Samples/0_Introduction/vectorAddMMAP/](./../doc.md)
