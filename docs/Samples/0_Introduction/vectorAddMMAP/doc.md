# Documentation for Folder `Samples/0_Introduction/vectorAddMMAP/`
...
- [multidevicealloc_memmap.cpp](./multidevicealloc_memmap.cpp_docs.md): C++ source code
- [vectorAddMMAP.cpp](./vectorAddMMAP.cpp_docs.md): C++ source code
- [vectorAdd_kernel.cu](./vectorAdd_kernel.cu_docs.md): CUDA kernel implementation
