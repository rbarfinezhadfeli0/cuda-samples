# Documentation for Folder `Samples/0_Introduction/simpleDrvRuntime/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleDrvRuntime/`.
...
- **Parent**: [Samples/0_Introduction/simpleDrvRuntime/](./../doc.md)
