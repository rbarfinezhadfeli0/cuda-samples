# Documentation for Folder `Samples/0_Introduction/clock_nvrtc/`
...
- [clock.cpp](./clock.cpp_docs.md): C++ source code
- [clock_kernel.cu](./clock_kernel.cu_docs.md): CUDA kernel implementation
