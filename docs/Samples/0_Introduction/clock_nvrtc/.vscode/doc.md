# Documentation for Folder `Samples/0_Introduction/clock_nvrtc/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/clock_nvrtc/`.
...
- **Parent**: [Samples/0_Introduction/clock_nvrtc/](./../doc.md)
