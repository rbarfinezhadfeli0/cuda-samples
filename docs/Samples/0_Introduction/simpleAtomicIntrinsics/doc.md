# Documentation for Folder `Samples/0_Introduction/simpleAtomicIntrinsics/`
...
- [simpleAtomicIntrinsics.cu](./simpleAtomicIntrinsics.cu_docs.md): CUDA kernel implementation
- [simpleAtomicIntrinsics_cpu.cpp](./simpleAtomicIntrinsics_cpu.cpp_docs.md): C++ source code
