# Documentation for Folder `Samples/0_Introduction/simpleAtomicIntrinsics/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleAtomicIntrinsics/`.
...
- **Parent**: [Samples/0_Introduction/simpleAtomicIntrinsics/](./../doc.md)
