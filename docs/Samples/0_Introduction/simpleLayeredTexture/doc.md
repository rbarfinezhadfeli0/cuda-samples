# Documentation for Folder `Samples/0_Introduction/simpleLayeredTexture/`
...
- [simpleLayeredTexture.cu](./simpleLayeredTexture.cu_docs.md): CUDA kernel implementation
