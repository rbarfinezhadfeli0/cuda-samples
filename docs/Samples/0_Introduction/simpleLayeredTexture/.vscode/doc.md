# Documentation for Folder `Samples/0_Introduction/simpleLayeredTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleLayeredTexture/`.
...
- **Parent**: [Samples/0_Introduction/simpleLayeredTexture/](./../doc.md)
