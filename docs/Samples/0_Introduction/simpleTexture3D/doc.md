# Documentation for Folder `Samples/0_Introduction/simpleTexture3D/`
...
- [simpleTexture3D.cpp](./simpleTexture3D.cpp_docs.md): C++ source code
- [simpleTexture3D_kernel.cu](./simpleTexture3D_kernel.cu_docs.md): CUDA kernel implementation
