# Documentation for Folder `Samples/0_Introduction/simpleTexture3D/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleTexture3D/`.
...
- **Parent**: [Samples/0_Introduction/simpleTexture3D/](./../doc.md)
