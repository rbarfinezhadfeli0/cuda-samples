# Documentation: Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c
---
## File Metadata
- **Path**: `Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c`
- **Filename**: `cuda_drvapi_dynlink.c`
- **Language**: c
- **Size**: 25909 bytes
- **Lines**: 668
...
---
## High-Level Overview
This file is a c source file with 11 function(s) in the CUDA Samples repository.
...
- **CUDA_INIT_D3D9**: `// #define CUDA_INIT_D3D10`
- **CUDA_INIT_D3D11**: `// #define CUDA_INIT_OPENGL`
- **STRINGIFY**: ``
- **GET_PROC_EX**: ``
- **GET_PROC_EX_V2**: ``
- **GET_PROC_EX_V3**: ``
...
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c
...
#### `CUDAAPI cuInit(unsigned int Flags, int cudaVersion)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c

#### `functions if(driverVer >= 5000)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c

#### `functions if(driverVer >= 4020)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c

#### `functions if(cudaVersion >= 4010 && __CUDA_API_VERSION >= 4010)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c

#### `interfaces if(cudaVersion >= 4000 && __CUDA_API_VERSION >= 4000)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c

#### `versions if(driverVer >= 4000)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c
