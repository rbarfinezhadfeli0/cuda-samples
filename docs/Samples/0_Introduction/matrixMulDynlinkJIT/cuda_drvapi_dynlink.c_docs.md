# Documentation for Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/matrixMulDynlinkJIT/cuda_drvapi_dynlink.c`.
