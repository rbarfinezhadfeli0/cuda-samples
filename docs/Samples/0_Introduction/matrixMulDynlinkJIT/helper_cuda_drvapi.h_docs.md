# Documentation: Samples/0_Introduction/matrixMulDynlinkJIT/helper_cuda_drvapi.h
---
## File Metadata
- **Path**: `Samples/0_Introduction/matrixMulDynlinkJIT/helper_cuda_drvapi.h`
...
---
## High-Level Overview
This file is a h source file with 10 function(s) in the CUDA Samples repository.
...
- **HELPER_CUDA_DRVAPI_H**: `#include <helper_string.h>`
- **MAX**: ``
- **EXIT_WAIVED**: `2`
- **checkCudaErrors**: ``
...
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/helper_cuda_drvapi.h
...
#### `bool checkCudaCapabilitiesDRV(int major_version, int minor_version, int devID)`
- Function in Samples/0_Introduction/matrixMulDynlinkJIT/helper_cuda_drvapi.h
