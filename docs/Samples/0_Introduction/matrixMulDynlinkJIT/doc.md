# Documentation for Folder `Samples/0_Introduction/matrixMulDynlinkJIT/`
...
- [matrixMulDynlinkJIT.cpp](./matrixMulDynlinkJIT.cpp_docs.md): C++ source code
- [matrixMul_gold.cpp](./matrixMul_gold.cpp_docs.md): C++ source code
