# Documentation for Folder `Samples/0_Introduction/matrixMulDynlinkJIT/extras/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/matrixMulDynlinkJIT/`.
...
- **Parent**: [Samples/0_Introduction/matrixMulDynlinkJIT/](./../doc.md)
