# Documentation for Samples/0_Introduction/matrixMulDynlinkJIT/extras/matrixMul_kernel_64.ptx

## File Metadata

- **Path**: `Samples/0_Introduction/matrixMulDynlinkJIT/extras/matrixMul_kernel_64.ptx`
- **Type**: .ptx
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/matrixMulDynlinkJIT/extras/matrixMul_kernel_64.ptx`.
