# Documentation for Samples/0_Introduction/matrixMulDynlinkJIT/README.md
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/matrixMulDynlinkJIT/README.md`.
