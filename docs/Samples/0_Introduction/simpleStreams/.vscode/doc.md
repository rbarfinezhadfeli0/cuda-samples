# Documentation for Folder `Samples/0_Introduction/simpleStreams/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleStreams/`.
...
- **Parent**: [Samples/0_Introduction/simpleStreams/](./../doc.md)
