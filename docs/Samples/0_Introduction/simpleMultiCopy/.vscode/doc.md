# Documentation for Folder `Samples/0_Introduction/simpleMultiCopy/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleMultiCopy/`.
...
- **Parent**: [Samples/0_Introduction/simpleMultiCopy/](./../doc.md)
