# Documentation for Folder `Samples/0_Introduction/simpleMPI/`
...
- [simpleMPI.cpp](./simpleMPI.cpp_docs.md): C++ source code
- [simpleMPI.cu](./simpleMPI.cu_docs.md): CUDA kernel implementation
