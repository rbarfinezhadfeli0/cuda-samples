# Documentation for Folder `Samples/0_Introduction/simpleMPI/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleMPI/`.
...
- **Parent**: [Samples/0_Introduction/simpleMPI/](./../doc.md)
