# Documentation for Samples/0_Introduction/simpleMPI/CMakeLists.txt
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/simpleMPI/CMakeLists.txt`.
