# Documentation for Folder `Samples/0_Introduction/vectorAdd/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/vectorAdd/`.
...
- **Parent**: [Samples/0_Introduction/vectorAdd/](./../doc.md)
