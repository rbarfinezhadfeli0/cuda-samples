# Documentation for Folder `Samples/0_Introduction/simpleZeroCopy/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleZeroCopy/`.
...
- **Parent**: [Samples/0_Introduction/simpleZeroCopy/](./../doc.md)
