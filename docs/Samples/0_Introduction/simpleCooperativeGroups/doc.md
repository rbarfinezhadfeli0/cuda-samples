# Documentation for Folder `Samples/0_Introduction/simpleCooperativeGroups/`
...
- [simpleCooperativeGroups.cu](./simpleCooperativeGroups.cu_docs.md): CUDA kernel implementation
