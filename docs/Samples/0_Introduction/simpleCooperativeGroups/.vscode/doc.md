# Documentation for Folder `Samples/0_Introduction/simpleCooperativeGroups/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleCooperativeGroups/`.
...
- **Parent**: [Samples/0_Introduction/simpleCooperativeGroups/](./../doc.md)
