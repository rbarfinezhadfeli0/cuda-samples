# Documentation for Samples/0_Introduction/simpleIPC/CMakeLists.txt

## File Metadata

- **Path**: `Samples/0_Introduction/simpleIPC/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/0_Introduction/simpleIPC
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/simpleIPC/CMakeLists.txt`.
