# Documentation for Folder `Samples/0_Introduction/simpleIPC/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleIPC/`.
...
- **Parent**: [Samples/0_Introduction/simpleIPC/](./../doc.md)
