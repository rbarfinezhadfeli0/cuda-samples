# Index of `Samples/0_Introduction/simpleIPC/`

## Overview

This folder is part of the CUDA Samples repository structure.

This folder contains files and subdirectories related to: `simpleIPC`

## Subfolders (1)

### .vscode/

- **Path**: `Samples/0_Introduction/simpleIPC/.vscode/`
...
| simpleIPC.cu | .cu | [docs](./simpleIPC.cu_docs.md) | [keywords](./simpleIPC.cu_kw.md) |
