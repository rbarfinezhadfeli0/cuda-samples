# Documentation for Folder `Samples/0_Introduction/simpleCubemapTexture/`
...
- [simpleCubemapTexture.cu](./simpleCubemapTexture.cu_docs.md): CUDA kernel implementation
