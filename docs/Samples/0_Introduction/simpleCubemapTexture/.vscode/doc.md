# Documentation for Folder `Samples/0_Introduction/simpleCubemapTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleCubemapTexture/`.
...
- **Parent**: [Samples/0_Introduction/simpleCubemapTexture/](./../doc.md)
