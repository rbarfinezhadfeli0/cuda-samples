# Documentation for Folder `Samples/0_Introduction/template/`
...
- [template.cu](./template.cu_docs.md): CUDA kernel implementation
- [template_cpu.cpp](./template_cpu.cpp_docs.md): C++ source code
