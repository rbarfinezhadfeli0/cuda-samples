# Documentation for Folder `Samples/0_Introduction/template/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/template/`.
...
- **Parent**: [Samples/0_Introduction/template/](./../doc.md)
