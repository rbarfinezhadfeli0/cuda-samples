# Documentation for Folder `Samples/0_Introduction/mergeSort/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/`.
...
- [bitonic.cu](./bitonic.cu_docs.md): CUDA kernel implementation
- [main.cpp](./main.cpp_docs.md): C++ source code
- [mergeSort.cu](./mergeSort.cu_docs.md): CUDA kernel implementation
- [mergeSort_host.cpp](./mergeSort_host.cpp_docs.md): C++ source code
- [mergeSort_validate.cpp](./mergeSort_validate.cpp_docs.md): C++ source code
...
- **Parent**: [Samples/0_Introduction/](./../doc.md)
