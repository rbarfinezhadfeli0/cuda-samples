# Documentation for Folder `Samples/0_Introduction/vectorAddDrv/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/vectorAddDrv/`.
...
- **Parent**: [Samples/0_Introduction/vectorAddDrv/](./../doc.md)
