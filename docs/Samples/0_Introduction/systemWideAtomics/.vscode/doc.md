# Documentation for Folder `Samples/0_Introduction/systemWideAtomics/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/systemWideAtomics/`.
...
- **Parent**: [Samples/0_Introduction/systemWideAtomics/](./../doc.md)
