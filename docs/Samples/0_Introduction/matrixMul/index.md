# Index of `Samples/0_Introduction/matrixMul/`

## Overview

This folder is part of the CUDA Samples repository structure.

This folder contains files and subdirectories related to: `matrixMul`

## Subfolders (1)

### .vscode/

- **Path**: `Samples/0_Introduction/matrixMul/.vscode/`
...
| matrixMul.cu | .cu | [docs](./matrixMul.cu_docs.md) | [keywords](./matrixMul.cu_kw.md) |
