# Documentation for Folder `Samples/0_Introduction/matrixMul/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/matrixMul/`.
...
- **Parent**: [Samples/0_Introduction/matrixMul/](./../doc.md)
