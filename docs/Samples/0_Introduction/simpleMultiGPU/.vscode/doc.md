# Documentation for Folder `Samples/0_Introduction/simpleMultiGPU/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleMultiGPU/`.
...
- **Parent**: [Samples/0_Introduction/simpleMultiGPU/](./../doc.md)
