# Documentation for Folder `Samples/0_Introduction/vectorAdd_nvrtc/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/vectorAdd_nvrtc/`.
...
- **Parent**: [Samples/0_Introduction/vectorAdd_nvrtc/](./../doc.md)
