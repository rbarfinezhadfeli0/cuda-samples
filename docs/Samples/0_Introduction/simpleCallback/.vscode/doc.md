# Documentation for Folder `Samples/0_Introduction/simpleCallback/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleCallback/`.
...
- **Parent**: [Samples/0_Introduction/simpleCallback/](./../doc.md)
