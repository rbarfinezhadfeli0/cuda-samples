# Documentation for Folder `Samples/0_Introduction/simplePitchLinearTexture/`
...
- [simplePitchLinearTexture.cu](./simplePitchLinearTexture.cu_docs.md): CUDA kernel implementation
