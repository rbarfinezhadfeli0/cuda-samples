# Documentation for Folder `Samples/0_Introduction/simplePitchLinearTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simplePitchLinearTexture/`.
...
- **Parent**: [Samples/0_Introduction/simplePitchLinearTexture/](./../doc.md)
