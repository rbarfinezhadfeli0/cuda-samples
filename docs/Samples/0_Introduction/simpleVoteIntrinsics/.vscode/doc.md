# Documentation for Folder `Samples/0_Introduction/simpleVoteIntrinsics/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleVoteIntrinsics/`.
...
- **Parent**: [Samples/0_Introduction/simpleVoteIntrinsics/](./../doc.md)
