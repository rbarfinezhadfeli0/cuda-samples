# Documentation for Folder `Samples/0_Introduction/simpleVoteIntrinsics/`
...
- [simpleVoteIntrinsics.cu](./simpleVoteIntrinsics.cu_docs.md): CUDA kernel implementation
