# Documentation for Folder `Samples/0_Introduction/simplePrintf/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simplePrintf/`.
...
- **Parent**: [Samples/0_Introduction/simplePrintf/](./../doc.md)
