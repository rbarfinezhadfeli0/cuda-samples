# Documentation for Samples/0_Introduction/simplePrintf/CMakeLists.txt

## File Metadata

- **Path**: `Samples/0_Introduction/simplePrintf/CMakeLists.txt`
- **Type**: .txt
- **Location**: Samples/0_Introduction/simplePrintf
- **Binary**: No
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/simplePrintf/CMakeLists.txt`.
