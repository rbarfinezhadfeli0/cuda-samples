# Documentation for Folder `Samples/0_Introduction/simpleHyperQ/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleHyperQ/`.
...
- **Parent**: [Samples/0_Introduction/simpleHyperQ/](./../doc.md)
