# Documentation for Folder `Samples/0_Introduction/simpleSurfaceWrite/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleSurfaceWrite/`.
...
- **Parent**: [Samples/0_Introduction/simpleSurfaceWrite/](./../doc.md)
