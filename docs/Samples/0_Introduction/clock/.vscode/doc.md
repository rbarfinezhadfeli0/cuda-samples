# Documentation for Folder `Samples/0_Introduction/clock/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/clock/`.
...
- **Parent**: [Samples/0_Introduction/clock/](./../doc.md)
