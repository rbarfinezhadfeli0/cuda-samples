# Documentation for Folder `Samples/0_Introduction/simpleTextureDrv/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleTextureDrv/`.
...
- **Parent**: [Samples/0_Introduction/simpleTextureDrv/](./../doc.md)
