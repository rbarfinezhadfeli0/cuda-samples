# Documentation for Folder `Samples/0_Introduction/simpleTextureDrv/`
...
- [simpleTextureDrv.cpp](./simpleTextureDrv.cpp_docs.md): C++ source code
- [simpleTexture_kernel.cu](./simpleTexture_kernel.cu_docs.md): CUDA kernel implementation
