# Documentation for Folder `Samples/0_Introduction/simpleTexture/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleTexture/`.
...
- **Parent**: [Samples/0_Introduction/simpleTexture/](./../doc.md)
