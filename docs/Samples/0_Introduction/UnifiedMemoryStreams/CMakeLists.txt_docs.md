# Documentation for Samples/0_Introduction/UnifiedMemoryStreams/CMakeLists.txt
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/UnifiedMemoryStreams/CMakeLists.txt`.
