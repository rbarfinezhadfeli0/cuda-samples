# Documentation for Folder `Samples/0_Introduction/UnifiedMemoryStreams/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/UnifiedMemoryStreams/`.
...
- **Parent**: [Samples/0_Introduction/UnifiedMemoryStreams/](./../doc.md)
