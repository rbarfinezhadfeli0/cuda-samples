# Documentation for Samples/0_Introduction/simpleAWBarrier/CMakeLists.txt

## File Metadata

- **Path**: `Samples/0_Introduction/simpleAWBarrier/CMakeLists.txt`
- **Type**: .txt
...
This file is part of the CUDA Samples repository, located at `Samples/0_Introduction/simpleAWBarrier/CMakeLists.txt`.
