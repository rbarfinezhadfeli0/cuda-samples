# Documentation for Folder `Samples/0_Introduction/simpleCUDA2GL/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleCUDA2GL/`.
...
- **Parent**: [Samples/0_Introduction/simpleCUDA2GL/](./../doc.md)
