# Documentation for Folder `Samples/0_Introduction/cudaOpenMP/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/cudaOpenMP/`.
...
- **Parent**: [Samples/0_Introduction/cudaOpenMP/](./../doc.md)
