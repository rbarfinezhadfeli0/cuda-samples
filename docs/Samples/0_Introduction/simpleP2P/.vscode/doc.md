# Documentation for Folder `Samples/0_Introduction/simpleP2P/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleP2P/`.
...
- **Parent**: [Samples/0_Introduction/simpleP2P/](./../doc.md)
