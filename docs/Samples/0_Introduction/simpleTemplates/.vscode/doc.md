# Documentation for Folder `Samples/0_Introduction/simpleTemplates/.vscode/`

## Role in the Project

This folder is part of the CUDA Samples collection under `Samples/0_Introduction/simpleTemplates/`.
...
- **Parent**: [Samples/0_Introduction/simpleTemplates/](./../doc.md)
